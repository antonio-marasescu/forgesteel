...
* 17+: You can teleport the target up to 6 squares.`,
  ...
  static buzzBalm: Item = FactoryLogic.createItem({
    ...
    effect:
      'As a maneuver, you rub the balm on your body and feel it tingle across your skin. You immediately end the bleeding and weakened conditions on yourself, and you gain a +2 bonus to speed until the start of your next turn.',
  });
...
Any fire caused by the oil is extinguished after burning for 1 hour.`,
  ...
  static healingPotion: Item = FactoryLogic.createItem({
    ...
    effect:
      'When you drink this potion as a maneuver, you regain Stamina equal to your recovery value without spending a Recovery.',
  });
...
* 17+: You can affect up to seven additional targets with this strike.`,
  ...
  static mirrorToken: Item = FactoryLogic.createItem({
    ...
    effect:
      'While the Mirror Token is on your person and you are targeted by a ranged strike, you can use a triggered action to crush the token and ignore the strike. Half the damage you would have taken and any effects of the triggering strike are imposed on the creature making the strike.',
  });
...
Small lightning bolts arc around the black cloud in this sphere, which creates a 3 cube of cloud and lightning when broken. Each creature who enters the cloud for the first time in a combat round or starts their turn there takes 5 lightning damage. Additionally, any creature is slowed while in the cloud`,
  ...
  static breathofDawn: Item = FactoryLogic.createItem({
    ...
    effect:
      'As a maneuver, you inhale the Breath of Dawn and are overcome with tranquility. You immediately end the frightened, slowed, and taunted conditions on yourself, and you gain a +8 bonus to Stability until the end of the encounter.',
  });
  ...
  static concealmentPotion: Item = FactoryLogic.createItem({
    ...
    effect:
      'When you drink this potion as a maneuver, light shifts around your body, letting you blend into the environment around you for 10 minutes. While this effect is active, you have a double edge on tests made to hide and sneak, and you can use the Hide maneuver even while you are observed.',
  });
  ...
  static floatPowder: Item = FactoryLogic.createItem({
    ...
    effect:
      'Dousing yourself in this powder as a maneuver causes you to weightlessly float off the ground. For 1 hour, your stability is reduced to 0, and you can fly and hover. Additionally, the hag that the powder is sourced from knows exactly where and when you use it.',
  });
  ...
  static purifiedJelly: Item = FactoryLogic.createItem({
    ...
    effect:
      'Consuming this potion as a maneuver causes your skin to shimmer and a set of tiny gills to appear on your neck or shoulders. For 1 hour, you can breathe in any environment, and you ignore the effects of harmful gases, vapors, and inhaled poisons.',
  });
...
At the start of each of your turns, each creature adjacent to the wall takes psychic damage equal to three times their Intuition score, and you can add 1 square to the wall for each creature who takes this damage. If no creature takes damage at the start of your turn, the larva dies and the wall disappears.`,
  ...
  static bottledParadox: Item = FactoryLogic.createItem({
    ...
    crafting: FactoryLogic.createProject({
      prerequisites:
        'A month’s lifespan from the creator or another willing creature, ground sapphire',
      source: 'Texts or lore in Caelian',
      characteristic: [Characteristic.Reason, Characteristic.Intuition],
      goal: 180,
    }),
...
* 17+: The target and each creature within 8 squares of them a slowed (save ends).`,
  ...
  static wardToken: Item = FactoryLogic.createItem({
    ...
    effect:
      'As a maneuver, you toss this stone above you and it shatters, showering you in dust. Until the end of the encounter, any enemy ability that targets you has a double bane.',
  });
...
Each time you use another Breath of Creation, you can create a new demiplane or expand a demiplane you have already created or visited. The size of an expanded demiplane increases by 20, and you create a second portal to the demiplane with a corresponding portal inside.`,
  ...
  static solaris: Item = FactoryLogic.createItem({
    ...
    crafting: FactoryLogic.createProject({
      ...
      source:
        'Reference materials in the First Language from the Infinite Library detailing incomplete instructions for building a sun',
      characteristic: [Characteristic.Reason, Characteristic.Intuition],
      goal: 360,
    }),
    effect:
  ...
  static brightCourt: Item = FactoryLogic.createItem({
    ...
    effect:
      'When opened as a maneuver, this vial bursts into a storm of multicolored lights. You and each ally within 5 squares of you regain 1d6 Recoveries. However, any mortal using this treasure draws the interest of a powerful fey noble.',
  });
