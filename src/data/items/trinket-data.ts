...
export class TrinketData {
  ...
  static deadweight: Item = FactoryLogic.createItem({
    ...
    effect:
      'While holding the Deadweight, you fall twice as fast, taking an extra 1 damage for each square you fall (to a maximum of 75 total damage from a single fall).',
    featuresByLevel: [
      {
        level: 1,
        features: [
...
If the object is too thick or has no open space on the other side, your hand becomes stuck inside the object. Removing your hand takes a successful hard Might test made as a main action.`,
  ...
  static geckoGloves: Item = FactoryLogic.createItem({
    ...
    effect:
      'While you wear these gloves, your grip is all but impossible to break. You can’t be disarmed, you can’t lose your grip while climbing unless you are force moved, and any creature grabbed by you takes a bane on the test for the Escape Grab maneuver.',
  });
  ...
  static hellchargerHelm: Item = FactoryLogic.createItem({
    ...
    effect:
      'Whenever you take the Charge action while wearing this helmet, you gain a +5 bonus to speed until the end of your current turn.',
    featuresByLevel: [
      {
        level: 1,
        features: [
...
**Special**: If you are a summoner, you regain the use of your standard melee free strike while wearing this bangle.`,
  ...
  static unbinderBoots: Item = FactoryLogic.createItem({
    ...
    effect:
      'These boots can temporarily unbind themselves from the chains of the earth, letting you move through the air as high as 3 squares above the ground from where you started. If you end your turn while you are still airborne, you fall.',
  });
...
**Special**: If you are a summoner, you regain the use of your standard ranged free strike while wearing this gauntlet.`,
  ...
  static mediatorsCharm: Item = FactoryLogic.createItem({
    ...
    effect:
      'While you wear the Mediator’s Charm, the patience of any NPC you negotiate with increases by 1 (to a maximum of 5). Additionally, at the start of a negotiation, you learn one of an NPC’s motivations or pitfalls of the Director’s choice.',
  });
  ...
  static necklaceOfTheBayou: Item = FactoryLogic.createItem({
    ...
    effect:
      'While you wear this necklace, you can breathe underwater, you can automatically swim at full speed while moving, and you ignore difficult terrain created by water or in marsh and similar terrain.',
  });
...
Additionally, you can shatter and destroy the crystallized essence as a maneuver to immediately give yourself 5 essence.`,
  ...
  static mirageBand: Item = FactoryLogic.createItem({
    ...
    effect:
      'While wearing the Mirage Band, you automatically perceive illusions for what they are, you can see invisible creatures, and supernatural effects can’t conceal creatures and objects from you.',
    featuresByLevel: [
      {
        level: 1,
        features: [
  ...
  static nullfieldResonatorRing: Item = FactoryLogic.createItem({
    ...
    effect:
      'You must be a null to wear this ring. While you do so, the area of your Null Field ability increases by 1.',
    featuresByLevel: [
      {
        level: 1,
        features: [
  ...
  static shiftingRing: Item = FactoryLogic.createItem({
    ...
    effect:
      'When targeted by any other effect that causes you to teleport, you can teleport up to 3 additional squares.',
    featuresByLevel: [
      {
        level: 1,
        features: [
...
At the end of each of your turns, each ally within 10 squares of you can make a saving throw against one effect they are suffering that is ended by a saving throw.`,
  ...
  static gravekeepersLantern: Item = FactoryLogic.createItem({
    ...
    crafting: FactoryLogic.createProject({
      prerequisites:
        'The powdered jawbone of a powerful spellcaster, wood from a tree marking multiple graves',
      source: 'Texts or lore in Hyrallic',
      characteristic: [Characteristic.Reason, Characteristic.Intuition],
      goal: 600,
    }),
