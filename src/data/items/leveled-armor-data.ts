      ...
      },
      {
        ...
        features: [
          FactoryLogic.feature.create({
            ...
            name: '',
            description:
              'An adjacent creature who deals damage to you takes 6 acid or poison damage.',
          }),
          FactoryLogic.feature.createBonus({
      ...
      },
      {
        ...
        features: [
          FactoryLogic.feature.create({
            ...
            name: '',
            description:
              'You instinctively know the location of any concealed creature within 5 squares.',
          }),
          FactoryLogic.feature.createBonus({
      ...
      },
      {
        ...
        features: [
          FactoryLogic.feature.create({
            ...
            name: '',
            description:
              'You instinctively know the location of any concealed creature within 10 squares.',
          }),
          FactoryLogic.feature.createBonus({
        ...
        features: [
          FactoryLogic.feature.createAbility({
            ability: FactoryLogic.createAbility({
              ...
              type: FactoryLogic.type.createTrigger('An adjacent enemy uses an ability', {
                free: true,
