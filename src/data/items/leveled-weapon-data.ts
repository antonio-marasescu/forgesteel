...
export class LeveledWeaponData {
      ...
      },
      {
        ...
        features: [
          FactoryLogic.feature.create({
            ...
            name: '',
            description:
              'You and each ally within 2 squares of you gains a +1 bonus to saving throws.',
          }),
          FactoryLogic.feature.createAbilityDamage({
  ...
  static knifeOfNine: Item = FactoryLogic.createItem({
    ...
    crafting: FactoryLogic.createProject({
      prerequisites:
        'Eighteen daggers - nine taken from personal enemies and nine gifted by friends',
      ...
      },
      {
        ...
        features: [
          FactoryLogic.feature.create({
            ...
            name: '',
            description:
              'The damage taken by a grabbed creature attempting to escape increases to 15.',
          }),
          FactoryLogic.feature.createAbilityDamage({
            id: 'item-molten-constrictor-5a',
            name: '',
