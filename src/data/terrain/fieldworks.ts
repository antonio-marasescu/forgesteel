        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionText('The bear trap must be manually reset.'),
            ],
          }),
        }),
      ],
    ...
    },
    {
      ...
      content: [
        ...
        FactoryLogic.feature.create({
          id: 'effect',
          name: 'Effect',
          description: 'The triggering creature can attempt to hide as a free triggered action.',
        }),
      ],
    },
  ],
...
export const snareTrap: Terrain = {
  ...
  name: 'Snare Trap',
  description: 'A rope snare is set to grab a target, leaving them hanging up-side down.',
  category: TerrainCategory.Fieldwork,
  level: 1,
  role: FactoryLogic.createTerrainRole(MonsterRoleType.Ambusher, TerrainRoleType.Trap),
  encounterValue: 1,
