  ...
  static chargebreaker: Imbuement = FactoryLogic.createImbuement({
    ...
    feature: FactoryLogic.feature.createAbility({
      ability: FactoryLogic.createAbility({
        ...
        name: 'Chargebreaker',
        type: FactoryLogic.type.createTrigger('The target willingly moves adjacent to you', {
          free: true,
        }),
        keywords: [AbilityKeyword.Melee, AbilityKeyword.Strike, AbilityKeyword.Weapon],
        distance: [FactoryLogic.distance.createMelee()],
        target: 'One enemy',
        sections: [FactoryLogic.createAbilitySectionText('The target takes 5 damage.')],
      }),
    }),
  });
