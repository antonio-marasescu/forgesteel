    ...
    feature: FactoryLogic.feature.createMultiple({
      ...
      features: [
        ...
        FactoryLogic.feature.create({
          ...
          name: 'Seeking',
          description:
            'If you think the name of a specific creature, place, or object to the implement, the implement points toward that target, provided you are on the same world.',
        }),
      ],
    }),
  });
    ...
    feature: FactoryLogic.feature.createMultiple({
      ...
      features: [
        ...
        FactoryLogic.feature.create({
          ...
          name: 'Thought Sending',
          description:
            'You can telepathically communicate with any willing creature who knows a language and whose name you know, provided they are on the same world as you. You must initiate the conversation, but once you do, the creature can respond until you end the conversation.',
        }),
      ],
    }),
  });
