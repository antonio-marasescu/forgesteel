          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                value: 5,
                effect:
                  'The ability loses the Ranged and Strike keywords, takes the Area keyword, and is a 10 × 1 line within 15 that targets each enemy and object in the area. ',
              }),
            ],
          }),
        }),
      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            sections: [FactoryLogic.createAbilitySectionText('The damage is halved.')],
          }),
        }),
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            name: 'Dive',
            type: FactoryLogic.type.createManeuver(),
            sections: [FactoryLogic.createAbilitySectionText('The hawk moves up to their speed.')],
          }),
        }),
        FactoryLogic.feature.create({
