      ...
      retainer: {
        ...
        level10: FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            type: FactoryLogic.type.createTrigger('A creature moves within distance', {
      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            name: 'Tempting Offer',
            type: FactoryLogic.type.createTrigger('A sapient enemy is reduced to 0 Stamina.', {
              free: true,
              qualifiers: ['Encounter'],
            }),
      ...
      retainer: {
        ...
        level10: FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            name: 'Horrific Feast',
            type: FactoryLogic.type.createTrigger('The gnasher reduces a creature to 0 Stamina.', {
              qualifiers: ['Encounter'],
            }),
            distance: [FactoryLogic.distance.createSelf()],
            target: 'Self',
      ...
      retainer: {
        ...
        level7: FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            distance: [
              FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 3, within: 3 }),
            ],
      ...
      retainer: {
        ...
        level10: FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            name: 'Death Miasma',
            type: FactoryLogic.type.createTrigger('The servitor is reduced to 0 Stamina.', {
              free: true,
              qualifiers: ['Encounter'],
            }),
            keywords: [AbilityKeyword.Area, AbilityKeyword.Magic],
