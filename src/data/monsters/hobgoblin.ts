      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            distance: [FactoryLogic.distance.createMelee(2), FactoryLogic.distance.createRanged(5)],
            target: 'One creature or object per minion',
            cost: 'signature',
            sections: [
              FactoryLogic.createAbilitySectionRoll(
          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                value: 2,
                effect:
                  'Each target who has <code>P < 2</code> is weakened (save ends). Any enemy who starts their turn within 3 squares of a target weakened this way and who has <code>P < 2</code> is weakened (save ends).',
              }),
            ],
          }),
        }),
          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                value: 2,
                effect:
                  'Each target is marked until the end of the encounter or until they die. The bloodlord’s allies gain an edge on strikes against any target marked this way. The bloodlord can have up to three targets marked this way. If they mark a new target who would exceed the limit, the oldest mark ends.',
              }),
            ],
          }),
        }),
