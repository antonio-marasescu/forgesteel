          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                value: 3,
                effect:
                  'Two allies within distance can make a free strike against the same target.',
              }),
            ],
          }),
        }),
          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                value: 4,
                effect:
                  'Each target who has <code>M < 3</code> is bleeding and slowed (save ends).',
              }),
            ],
          }),
        }),
          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                value: 4,
                effect:
                  'Two allies within distance move up to their speed and can use a signature ability.',
              }),
            ],
          }),
        }),
          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                value: 3,
                effect:
                  'Each target shifts up to their speed and can make a free strike against one enemy of the talent’s choice. The target can’t be moved in a way that would harm them.',
              }),
            ],
          }),
        }),
          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                value: 4,
                effect:
                  'Each target moves up to their speed and can make a free strike against one enemy of the talent’s choice. The target’s movement can provoke opportunity attacks, but they can’t otherwise be moved in a way that would harm them.',
              }),
            ],
          }),
        }),
