            ...
            sections: [
              FactoryLogic.createAbilitySectionRoll(
                FactoryLogic.createPowerRoll({
                  ...
                  tier2:
                    '4 damage; push 2, or the bloodspark can shift 2 square away from the target',
                  tier3:
                    '5 damage; push 4, or the bloodspark can shift 4 square away from the target',
                }),
              ),
            ],
          }),
          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                value: 2,
                effect:
                  'An ally targeted by this ability can make a free strike after the forced movement is resolved.',
              }),
            ],
          }),
        }),
      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            distance: [
              FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 3, within: 2 }),
            ],
            target: 'Each enemy in the area',
            sections: [
              FactoryLogic.createAbilitySectionRoll(
