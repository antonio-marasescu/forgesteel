      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
            distance: [
              FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 4, within: 5 }),
            ],
            target: 'Each enemy in the area',
            sections: [
              FactoryLogic.createAbilitySectionText(
      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            name: 'Spew Slide',
            type: FactoryLogic.type.createTrigger('The gunge takes damage from a melee strike.', {
              free: true,
            }),
            cost: 1,
            keywords: [AbilityKeyword.Area],
            ...
            sections: [
              FactoryLogic.createAbilitySectionRoll(
                FactoryLogic.createPowerRoll({
                  ...
                  tier3:
                    '15 corruption damage; two **frenzieds** appears in an unoccupied spaces adjacent to each target.',
                }),
              ),
            ],
          }),
      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            keywords: [AbilityKeyword.Area, AbilityKeyword.Magic],
            distance: [
              FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 5, within: 1 }),
            ],
            target: 'Each enemy in the area',
            sections: [
              FactoryLogic.createAbilitySectionText(
              ...
              FactoryLogic.createAbilitySectionSpend({
                value: 2,
                effect:
                  'The blight phage chooses three 2 cube areas within 10 squares of the phage. Each area is covered with blight and treated as if affected by **Seeping Blight**.',
              }),
            ],
          }),
        }),
      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            distance: [FactoryLogic.distance.createSelf()],
            target: 'Self',
            sections: [FactoryLogic.createAbilitySectionText('The chimeron halves the damage.')],
          }),
        }),
        FactoryLogic.feature.create({
          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                value: 3,
                effect:
                  'The izyak can vertical slide any target restrained this way up to 6 squares instead. A target left in midair doesn’t fall until the restrained condition ends.',
              }),
            ],
          }),
        }),
      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            keywords: [AbilityKeyword.Area, AbilityKeyword.Magic],
            distance: [
              FactoryLogic.distance.create({ type: AbilityDistanceType.Burst, value: 20 }),
            ],
