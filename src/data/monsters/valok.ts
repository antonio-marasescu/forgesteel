      ...
      features: [
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            distance: [
              FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 3, value2: 5 }),
            ],
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            distance: [
              FactoryLogic.distance.create({ type: AbilityDistanceType.Wall, value: 6, value2: 3 }),
            ],
            target: 'Special',
            sections: [
              FactoryLogic.createAbilitySectionText(
      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            keywords: [AbilityKeyword.Area],
            distance: [
              FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 4, value2: 1 }),
            ],
            target: 'Each enemy and the object in the area',
            sections: [
      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            name: 'Quick Blast',
            type: FactoryLogic.type.createTrigger('The target deals damage to the war engine', {
              free: true,
            }),
            keywords: [AbilityKeyword.Ranged, AbilityKeyword.Strike, AbilityKeyword.Weapon],
            distance: [FactoryLogic.distance.createRanged(20)],
