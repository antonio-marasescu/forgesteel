  ...
  malice: [
    FactoryLogic.feature.createMaliceAbility({
      ability: FactoryLogic.createAbility({
        ...
        distance: [
          FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 1, within: 3 }),
        ],
        target: 'Special',
        sections: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionText(
                'The target has a bane on their next power roll.',
              ),
            ],
          }),
        }),
            ...
            sections: [
              FactoryLogic.createAbilitySectionRoll(
                FactoryLogic.createPowerRoll({
                  ...
                  tier2: '3 damage',
                  tier3:
                    '5 damage; the wildling makes a free strike on a creature adjacent to the target',
                }),
              ),
            ],
          }),
      ...
      features: [
            ...
            sections: [
              FactoryLogic.createAbilitySectionRoll(
                FactoryLogic.createPowerRoll({
                  ...
                  tier3:
                    "7 psychic damage; I<2 the target makes a free strike against a creature of the cackler's choice",
                }),
              ),
              FactoryLogic.createAbilitySectionText(
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              FactoryLogic.createAbilitySectionText(
                'Each enemy target makes an **Intuition test**.',
              ),
              FactoryLogic.createAbilitySectionRoll(
                FactoryLogic.createPowerRoll({
