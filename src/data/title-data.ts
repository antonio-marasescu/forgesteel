...
You find an agent who can provide you with three pieces of information about the settlement you’re in, such as the location of a hidden person, a secret entrance into a guarded area, or the negotiation motivation or pitfall of an important person.`,
  ...
  static goldenrod: Title = {
    ...
    features: [
      FactoryLogic.feature.create({
        ...
        name: 'Goldenrod',
        description:
          'Each time you undertake the Fishing project, you can reroll one project roll.',
      }),
    ],
    selectedFeatureID: '',
  };
    ...
    features: [
      ...
      FactoryLogic.feature.createAbility({
        ability: FactoryLogic.createAbility({
          ...
          distance: [FactoryLogic.distance.createSpecial('Adjacent')],
          target: 'One creature',
          sections: [FactoryLogic.createAbilitySectionText('Make a free strike.')],
        }),
      }),
      FactoryLogic.feature.createMultiple({
        ...
        features: [
          ...
          FactoryLogic.feature.create({
            ...
            name: 'Stink of Magic',
            description:
              'You can’t be surprised by constructs, undead, or creatures from another world.',
          }),
        ],
      }),
    ],
  ...
  static marshal: Title = {
    ...
    name: 'Marshal',
    description:
      '“I said you had twenty-four hours to leave town. That was… what, about 24 hours ago?”',
    echelon: 1,
    prerequisites:
  ...
  static monsterBane: Title = {
    ...
    echelon: 1,
    prerequisites:
      'You defeat a leader or solo monster with a Reason score of –2 or lower, such as an arixx.',
    features: [
      FactoryLogic.feature.create({
...
At a dramatic moment determined by the Director, you rejoin your party with an explanation for your narrow escape, and how you found your new trinket along the way.`,
  ...
  static ratcatcher: Title = {
    ...
    echelon: 1,
    prerequisites:
      'You defeat a leader or solo monster that is size 1S or smaller, such as a goblin monarch.',
    features: [
      FactoryLogic.feature.create({
...
**Special**: If two or more heroes in the party have this title from the same source, the party starts combat encounters with a squad of six minions instead. At the start of each round of combat, the heroes decide who controls the squad as a part of their turn.`,
  ...
  static sigilwright: Title = {
    ...
    echelon: 2,
    prerequisites:
      'You complete a ritual to summon a non-minion entity using a summoning circle you drew.',
    features: [
      FactoryLogic.feature.create({
