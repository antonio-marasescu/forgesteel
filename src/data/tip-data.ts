  ...
  static getTips = (): Tip[] => {
    return [
      ...
      FactoryLogic.createTip({
        ...
        content:
          "You can access your hero's resources, inventory, projects, and more through the **Tools** button.",
      }),
      FactoryLogic.createTip({
      ...
      FactoryLogic.createTip({
        ...
        content:
          "You can manage your hero's equipment in the **Inventory** tab. If you have an imbued item, this is where to set it up.",
      }),
      FactoryLogic.createTip({
        image: heroSheetProjects,
        content:
          "On the **Projects** tab you can track the progress of your hero's downtime projects.",
      }),
      FactoryLogic.createTip({
      ...
      FactoryLogic.createTip({
        ...
        content:
          "If your hero has a mount, a retainer, or can summon monsters, you'll see them in your **Retinue** tab.",
        isNew: true,
      }),
      // #endregion
      ...
      FactoryLogic.createTip({
        ...
        content:
          "If you want to use a custom sourcebook when you're building your hero, you'll need to select it on the **Start** page.",
      }),
      FactoryLogic.createTip({
      ...
      FactoryLogic.createTip({
        ...
        content:
          'Everything in the Library comes from a sourcebook - you can create your own sourcebooks for homebrew content.',
      }),
      FactoryLogic.createTip({
      ...
      FactoryLogic.createTip({
        ...
        content:
          "When you're creating a homebrew monster, Forge Steel shows you similar monsters to help you choose your new monster's stat values.",
      }),
      FactoryLogic.createTip({
        image: homebrewKitTuning,
        content:
          "When you're creating a homebrew kit, Forge Steel helps you to make sure your kit isn't overpowered.",
        isNew: true,
      }),
      FactoryLogic.createTip({
        image: homebrewMonsterBuilderGenesplice,
        content:
          "When you're creating a homebrew monster, you can use the **Genesplice** tool to quickly jumble existing creatures together to create something new.",
        isNew: true,
      }),
      // #endregion
      ...
      FactoryLogic.createTip({
        ...
        content:
          "If you tap the Information icon in the encounter header, you'll see information that'll help you pick minis for this encounter.",
        isNew: true,
      }),
      FactoryLogic.createTip({
      ...
      FactoryLogic.createTip({
        ...
        content:
          'Forge Steel makes it easy to build encounters by adding monsters and terrain elements.',
      }),
      FactoryLogic.createTip({
        image: playbookEncounterRandom,
        content:
          'If you need an encounter in a hurry, Forge Steel can generate one - you just specify the difficulty and, optionally, the sort of monsters you want it to showcase.',
        isNew: true,
      }),
      // #endregion
      ...
      FactoryLogic.createTip({
        ...
        content:
          'Forge Steel makes it easy to build negotiations by adding motivatons and pitfalls.',
      }),
      // #endregion
      ...
      FactoryLogic.createTip({
        ...
        content:
          "If you're in a hurry, you can get Forge Steel to generate a random tactical map for your encounters.",
      }),
      // #endregion
      ...
      FactoryLogic.createTip({
        ...
        content:
          'In the **Session** screen you can set counters, counting down (or up) to track whatever needs to be tracked in your adventure.',
      }),
      FactoryLogic.createTip({
        image: sessionEncounter,
        content:
          'In the **Session** screen you can run encounters, easily handling stamina and conditions for each of the combatants.',
      }),
      FactoryLogic.createTip({
        image: sessionMontage,
        content:
          "In the **Session** screen you can run montages, tracking each of the heroes' successes and failures.",
      }),
      FactoryLogic.createTip({
        image: sessionNegotiation,
        content:
          "In the **Session** screen you can run negotiations, tracking the NPC's interest and patience.",
      }),
      FactoryLogic.createTip({
        image: sessionMultiple,
        content:
          "If you're running more than one encounter (or montage, or negotiation) you can switch between them at the top of the **Session** screen.",
      }),
      // #endregion
      ...
      FactoryLogic.createTip({
        image: appNavigation,
        content:
          "Use the navigation bar, at the bottom left of the screen, to switch between Forge Steel's sections.",
      }),
      FactoryLogic.createTip({
        image: appReference,
        content:
          'Press the Reference button, at the bottom right of the screen, to access the reference section.',
      }),
      FactoryLogic.createTip({
        image: appRoll,
        content:
          'Press the Roll button, at the bottom right of the screen, to make a power roll or saving throw.',
      }),
      FactoryLogic.createTip({
        image: appSettings,
        content:
          'Press the Settings button, at the bottom right of the screen, to modify app preferences and settings.',
      }),
      FactoryLogic.createTip({
        image: appAbout,
        content:
          'Spotted a bug? Have an idea for a new feature? Press the About button to find links to the issue tracker, or post on the MCDM Draw Steel Discord.',
      }),
      // #endregion
    ];
  };
