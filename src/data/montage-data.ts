    ...
    sections: [
      {
        ...
        challenges: [
          ...
          FactoryLogic.createMontageChallenge({
            ...
            name: 'Fortification',
            description:
              'Characters can help build or repair walls and other defensive structures.',
            characteristics: [Characteristic.Might, Characteristic.Reason],
    ...
    sections: [
      {
        ...
        challenges: [
          ...
          FactoryLogic.createMontageChallenge({
            ...
            characteristics: [Characteristic.Intuition, Characteristic.Reason],
            skills:
              'Navigate, Read Person, an appropriate skill from the Lore group (Nature to follow an animal or Criminal Underworld to follow a criminal, and so forth)',
          }),
          FactoryLogic.createMontageChallenge({
            id: 'push-ahead',
            name: 'Push Ahead',
    ...
    sections: [
      {
        ...
        challenges: [
          FactoryLogic.createMontageChallenge({
            ...
            characteristics: [Characteristic.Intuition, Characteristic.Reason],
            skills:
              'Heal, Nature, an appropriate skill from the Crafting skill group (such as Alchemy to make bug repellent)',
          }),
          FactoryLogic.createMontageChallenge({
            id: 'carry-baggage',
            name: 'Carry Baggage',
          ...
          FactoryLogic.createMontageChallenge({
            ...
            name: 'Push On',
            description:
              'Characters must be ready to pick up the pace and push past their fatigue.',
            characteristics: [Characteristic.Might],
            skills:
              'Endurance, Lead; Handle Animals, Drive, or Ride if the party has mounts or vehicles',
          }),
          FactoryLogic.createMontageChallenge({
            id: 'scout-ahead',
            name: 'Scout Ahead',
