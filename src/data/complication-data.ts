          ...
          sections: [
            FactoryLogic.createAbilitySectionRoll(
              FactoryLogic.createPowerRoll({
                ...
                tier1:
                  'You summon a hostile demon of your level or lower who attacks you at the end of the respite. The demon gets to act first in the combat, no matter any other creature’s traits or abilities.',
                tier2: 'You learn nothing and your time is wasted.',
                tier3:
                  'You learn one bonus heroic ability from your class that you qualify for. You only know the ability until you finish your next respite.',
              }),
            ),
          ],
        }),
  ...
  static masterChef: Complication = {
    ...
    features: [
      ...
      FactoryLogic.feature.create({
        ...
        description:
          'The first time each day you eat food you didn’t prepare, you lose 2 Recoveries.',
      }),
    ],
  };
  ...
  static mundane: Complication = {
    ...
    features: [
      ...
      FactoryLogic.feature.create({
        ...
        description:
          'While you are carry more than three magic treasures, you take a bane on power rolls.',
      }),
    ],
  };
  ...
  static outlaw: Complication = {
    ...
    features: [
      ...
      FactoryLogic.feature.create({
        ...
        description:
          'Law enforcement officials and bounty hunters who recognize you attempt to arrest you.',
      }),
    ],
  };
    ...
    features: [
      FactoryLogic.feature.createAbility({
        ability: FactoryLogic.createAbility({
          ...
          sections: [
            FactoryLogic.createAbilitySectionText(
              'Using this ability costs all your Heroic Resources.',
            ),
            FactoryLogic.createAbilitySectionRoll(
              FactoryLogic.createPowerRoll({
                characteristic: [
                ...
                tier1:
                  '1 psychic damage for each heroic resources you spend, to a maximum equal your level',
                tier2:
                  '1 psychic damage for each heroic resource you spend, to a maximum equal to your level + your highest characteristic',
  ...
  static rival: Complication = {
    ...
    features: [
      FactoryLogic.feature.create({
        ...
        name: 'Rival Benefit',
        description:
          'Choose one of your skills. That skill grants a +3 bonus to tests instead of +2.',
      }),
      FactoryLogic.feature.create({
        id: 'comp-rival-d',
        name: 'Rival Drawback',
  ...
  static silentSentinel: Complication = {
    ...
    features: [
      ...
      FactoryLogic.feature.create({
        ...
        description:
          'Whenever you take sonic damage, you are dazed until the end of your next turn.',
      }),
      FactoryLogic.feature.createDamageModifier({
  ...
  static thrillSeeker: Complication = {
    ...
    features: [
      FactoryLogic.feature.create({
        ...
        description:
          'Each time your party reaches 2, 4, and 6 Victories, you earn the party a hero token.',
      }),
      FactoryLogic.feature.create({
          ...
          sections: [
            FactoryLogic.createAbilitySectionRoll(
              FactoryLogic.createPowerRoll({
                ...
                tier1:
                  'You receive a painful vision that is fractal and inscrutable. When you finish the respite, you lose 1 Recovery.',
                tier2:
                  'You experience a vision of an event currently happening in your world. The vision lasts for only a few seconds, but the information you glean is helpful to you.',
  ...
  static waterborn: Complication = {
    ...
    features: [
      FactoryLogic.feature.create({
        ...
        description:
          'You can automatically swim at full speed while moving, and you can breathe underwater.',
      }),
      FactoryLogic.feature.createAbility({
        ability: FactoryLogic.createAbility({
          ...
          sections: [
            ...
            FactoryLogic.createAbilitySectionText(
              'You can forgo dealing damage with this ability.',
            ),
          ],
        }),
      }),
