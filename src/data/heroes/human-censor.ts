                              ...
                              sections: [
                                {
                                  ...
                                  roll: {
                                    ...
                                    bonus: 0,
                                    tier1:
                                      '8 + I damage; A < [weak], prone and restrained (save ends)',
                                    tier2:
                                      '12 + I damage; A < [average], prone and restrained (save ends)',
                                    tier3:
                                      '16 + I damage; A < [strong], prone and restrained (save ends)',
                                  },
                                },
                              ],
                              preEffect: '',
              ...
              ability: {
                ...
                sections: [
                  ...
                  },
                  {
                    ...
                    repeatable: false,
                    effect:
                      'You can end one effect on the target that is ended by a saving throw or that ends at the end of their turn, or a prone target can stand up.',
                  },
                ],
                preEffect: '',
                powerRoll: null,
        ...
        sections: [
          {
            ...
            roll: {
              ...
              bonus: 0,
              tier1:
                '3 + M holy damage; if the target has P < [weak], each enemy within 2 squares of them is frightened of you (save ends)',
              tier2:
                '5 + M holy damage; if the target has P < [average], each enemy within 2 squares of them is frightened of you (save ends)',
              tier3:
                '8 + M holy damage; if the target has P < [strong], each enemy within 2 squares of them is frightened of you (save ends)',
            },
          },
          {
            type: 'text',
                            ...
                            sections: [
                              {
                                ...
                                roll: {
                                  ...
                                  tier2:
                                    '12 + M holy damage; P < [average], frightened (save ends)',
                            ...
                            sections: [
                              {
                                ...
                                roll: {
                                  ...
                                  bonus: 0,
                                  tier1:
                                    '5 + M damage; P < [weak], the target is banished (save ends)',
                                  tier2:
                                    '8 + M damage; P < [average], the target is banished (save ends)',
                                  tier3:
                                    '11 + M damage; P < [strong], the target is banished (save ends)',
                                },
                              },
                              {
                                type: 'text',
                            ...
                            sections: [
                              {
                                ...
                                roll: {
                                  ...
                                  tier2:
                                    '10 + P psychic damage; P < [average], frightened (save ends)',
                                  tier3:
                                    '12 + P psychic damage; P < [strong], frightened (save ends)',
                                },
                              },
                              {
                                type: 'text',
                            ...
                            sections: [
                              {
                                ...
                                roll: {
                                  ...
                                  bonus: 0,
                                  tier1:
                                    '8 + M damage; as a free triggered action, one ally within 10 squares of the target can use a strike signature ability against the target',
                                  tier2:
                                    '12 + M damage; as a free triggered action, one ally within 10 squares of the target can use a strike signature ability that gains an edge against the target',
                                  tier3:
                                    '16 + M damage; as a free triggered action, two allies within 10 squares of the target can each use a strike signature ability that gains an edge against the target',
                                },
                              },
                              {
                                type: 'text',
