        ...
        sections: [
          ...
          },
          {
            ...
            roll: {
              ...
              tier3:
                '9 + R damage; R < [strong], the target has weakness equal to 5 + your Reason score (save ends)',
            },
          },
        ],
        preEffect: '',
        ...
        sections: [
          {
            ...
            roll: {
              ...
              tier2:
                '5 + P corruption damage; the target is flung through time, and if P < [average] they are weakened (save ends)',
              tier3:
                '8 + P corruption damage; the target is flung through time, and if P < [strong] they are weakened (save ends)',
            },
          },
          {
            type: 'text',
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            repeatable: false,
            effect:
              'The size of the aura increases by 1. Whenever your aura reflects an ability, you take 2d6 damage and forget a memory, as determined by you and the Director.',
          },
        ],
        preEffect: '',
        powerRoll: null,
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            repeatable: false,
            effect:
              'The potency of this ability increases by 1. You take 2d6 damage and gain 3 surges that you can use immediately.',
          },
        ],
        preEffect: '',
        powerRoll: null,
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            repeatable: false,
            effect:
              'If you obtain a tier 2 outcome or better, you are slowed until the end of your turn and each target is slowed until the end of their turn.',
          },
        ],
        preEffect: '',
        powerRoll: null,
        ...
        sections: [
          {
            ...
            roll: {
              ...
              tier2:
                '13 damage; A < [average], the target is stitched to the other target (save ends)',
              tier3:
                '17 damage; A < [strong], the target is stitched to the other target (save ends)',
            },
          },
          {
            type: 'text',
        ...
        sections: [
          {
            ...
            roll: {
              ...
              tier2:
                '17 + R damage; R < [average], the target takes a bane on power rolls (save ends)',
              tier3:
                '23 + R damage; R < [strong], the target has a double bane on power rolls (save ends)',
            },
          },
          {
            type: 'text',
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            repeatable: false,
            effect:
              'You and the target both permanently grow visibly younger (the equivalent of 20 human years, to the minimum of an 18-year-old). Additionally, you are weakened and slowed (save ends).',
          },
        ],
        preEffect: '',
        powerRoll: null,
                  ...
                  ability: {
                    ...
                    sections: [
                      ...
                      },
                      {
                        ...
                        repeatable: true,
                        effect:
                          'The size of the creature or object you can target increases by 1 for every 2 clarity spent.',
                      },
                      {
                        type: 'field',
                        name: 'Spend',
                            ...
                            sections: [
                              {
                                ...
                                roll: {
                                  ...
                                  tier2:
                                    'Slide 8 + R; M < [average], the forced movement is vertical',
                                  tier3:
                                    'Slide 12 + R; prone; M < [strong], the forced movement is vertical',
                                },
                              },
                              {
                                type: 'field',
