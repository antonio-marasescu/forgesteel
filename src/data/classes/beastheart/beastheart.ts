                  ...
                  FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        ...
                        FactoryLogic.createAbilitySectionSpend({
                          effect:
                            'The target is pushed up to an additional number of squares equal to the bear’s Might score.',
                        }),
                      ],
                    }),
                  }),
                    ...
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        ...
                        FactoryLogic.createAbilitySectionSpend({
                          repeatable: true,
                          effect:
                            'For each ferocity you spend (max 4), the damage increases by 1 and the size of the cube increases by 1.',
                        }),
                      ],
                    }),
                  }),
                  ...
                  FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        ...
                        FactoryLogic.createAbilitySectionSpend({
                          effect:
                            'Until the grab ends, the creature takes acid damage equal to the sphere’s Might score at the end of each of the sphere’s turns.',
                        }),
                      ],
                    }),
                  }),
                  ...
                  FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        ...
                        FactoryLogic.createAbilitySectionSpend({
                          effect:
                            'The hellhound adds their Intuition score to either the damage or the range.',
                        }),
                      ],
                    }),
                  }),
                  ...
                  FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        ...
                        FactoryLogic.createAbilitySectionSpend({
                          effect:
                            'The panther can jump up to their speed before using this ability. If they jump at least 1 square in this way, a target who is M < [strong] is prone.',
                        }),
                      ],
                    }),
                  }),
                  ...
                  FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        ...
                        FactoryLogic.createAbilitySectionSpend({
                          effect:
                            'An enemy affected by Spore Puff who is M < [strong] is dazed (EoT).',
                        }),
                      ],
                    }),
                  }),
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                effect:
                  '(Beastheart only) You rip your heart from your chest and throw it up to 10 squares to an unoccupied space. Your heart then transforms into your companion, teleporting them to that space instead of to your space.',
              }),
              FactoryLogic.createAbilitySectionSpend({
                repeatable: true,
                effect:
                  'The teleported creature gains additional temporary Stamina equal to their Recovery value times the number of Ferocity you spend in this way (max 3). If they are dead, you can spend 3 Ferocity to restore them to life with 1 Stamina, even if their body was destroyed, and they gain no temporary Stamina.',
              }),
            ],
          }),
        }),
  ...
  abilities: [
      ...
      sections: [
        FactoryLogic.createAbilitySectionRoll(
          FactoryLogic.createPowerRoll({
            ...
            tier3:
              '11 + M damage; A < [strong], bleeding (EoT); each of you can spend a Recovery and shift up to 2 squares',
          }),
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionSpend({
          effect:
            'This ability also affects a 2 burst around you. An enemy in both areas is only affected once.',
        }),
      ],
    }),
    FactoryLogic.createAbility({
    ...
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionSpend({
          effect:
            'This ability also affects a 3 burst around your companion. Creatures in this second burst are taunted by your companion. An enemy in both areas is taunted only by you.',
        }),
      ],
    }),
    FactoryLogic.createAbility({
    ...
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'If you are hidden, you remain hidden after the attack.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
    ...
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionSpend({
          ...
          repeatable: true,
          effect:
            'You can spend up to 6 extra ferocity. For each 2 extra ferocity you spend, the size of the burst is increased by 1, 2 is added to the power roll, and you take 5 damage that can’t be reduced in any way. You can decide how much ferocity you spend after you make the power roll.',
        }),
      ],
    }),
    FactoryLogic.createAbility({
