  ...
  featuresByLevel: [
    {
      ...
      features: [
        ...
        FactoryLogic.feature.createPackageContent({
          ...
          description:
            'This strike deals cold, fire, lightning, or sonic damage. You gain a surge.',
          tag: 'feral-strike',
        }),
          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                effect:
                  'When you teleport in this way, each enemy adjacent to your original position takes cold, fire, lightning, or sonic damage equal to your Intuition score.',
              }),
            ],
          }),
        }),
              ...
              feature: FactoryLogic.feature.createAbility({
                ability: FactoryLogic.createAbility({
                  ...
                  sections: [
                    ...
                    FactoryLogic.createAbilitySectionSpend({
                      effect:
                        'If you are within 2 squares of the enemy, you can use a free maneuver to wield a second whip, dealing extra fire or lightning damage to the target equal to your Intuition score.',
                    }),
                  ],
                }),
              }),
    ...
    },
    {
      ...
      features: [
        FactoryLogic.feature.create({
          ...
          description:
            'You both gain damage immunity 10 to cold, fire, lightning, and sonic damage.',
        }),
      ],
    },
    {
