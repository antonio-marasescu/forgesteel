...
export const guardian: SubClass = {
  ...
  name: 'Guardian',
  description:
    'You are the fearless defender of your pack: anyone who harms them must go through you.',
  featuresByLevel: [
    {
      level: 1,
      features: [
          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              FactoryLogic.createAbilitySectionText(
                'The triggering damage is halved for the ally.',
              ),
              FactoryLogic.createAbilitySectionSpend({
                effect:
                  'You spend one of your Recoveries; the ally regains the Stamina instead of you.',
              }),
            ],
          }),
        }),
                ...
                ability: FactoryLogic.createAbility({
                  ...
                  sections: [
                    ...
                    FactoryLogic.createAbilitySectionSpend({
                      value: 2,
                      effect:
                        'Your companion can use this ability as a triggered action against an enemy who damages you.',
                    }),
                  ],
                }),
              }),
              ...
              feature: FactoryLogic.feature.createAbility({
                ability: FactoryLogic.createAbility({
                  ...
                  sections: [
                    ...
                    FactoryLogic.createAbilitySectionSpend({
                      effect:
                        'This ability also affects a 3 burst around you. An enemy in both areas is only affected once.',
                    }),
                  ],
                }),
              }),
