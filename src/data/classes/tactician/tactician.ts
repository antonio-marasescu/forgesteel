...
Additionally, whenever an ally uses a heroic ability that targets one or more creatures marked by you, they spend 2 fewer of their Heroic Resource on that ability (minimum 1).`,
  ...
  abilities: [
    ...
    FactoryLogic.createAbility({
      ...
      cost: 3,
      sections: [FactoryLogic.createAbilitySectionText('Each target can move up to their speed.')],
    }),
    FactoryLogic.createAbility({
    ...
    FactoryLogic.createAbility({
      ...
      target: 'Three allies',
      cost: 5,
      sections: [FactoryLogic.createAbilitySectionText('Each target can make a free strike.')],
    }),
    FactoryLogic.createAbility({
