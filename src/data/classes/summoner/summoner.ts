              ...
              feature: FactoryLogic.feature.createAbility({
                ability: FactoryLogic.createAbility({
                  ...
                  sections: [
                    ...
                    FactoryLogic.createAbilitySectionSpend({
                      effect:
                        'If the triggering damage is from an ability that uses a power roll, the power roll gains an edge.',
                    }),
                  ],
                }),
              }),
              ...
              feature: FactoryLogic.feature.createAbility({
                ability: FactoryLogic.createAbility({
                  ...
                  sections: [
                    ...
                    FactoryLogic.createAbilitySectionSpend({
                      effect:
                        'Instead of commanding an existing minion, you summon a signature minion into an unoccupied space adjacent to the target to take the strike.',
                    }),
                  ],
                }),
              }),
...
If they move adjacent to their target, become targeted by an opportunity attack, or stop moving, they explode, dealing 2 damage to one adjacent creature or object and pushing them 1 square. If a target is affected by two or more minions’ explosions, the effects stack. These minions activate no effects upon death, and you gain no essence from their deaths.`),
    ...
    FactoryLogic.createAbility({
      ...
      name: 'Cavalry Call',
      description:
        'A lone squad appears to disrupt the enemy’s plans and peel off their forces, one by one.',
      type: FactoryLogic.type.createMain(),
      keywords: [AbilityKeyword.Magic],
      distance: [FactoryLogic.distance.createSummoner()],
      target: 'Special',
...
These minions die at the end of your turn, activate no effects upon death, and you gain no essence from their deaths`),
    ...
    FactoryLogic.createAbility({
      ...
      distance: [FactoryLogic.distance.createMelee(), FactoryLogic.distance.createSummoner()],
...
Each target can immediately make each of their saving throws and stand up from prone.`),
    ...
    FactoryLogic.createAbility({
      ...
      keywords: [
        AbilityKeyword.Area,
        AbilityKeyword.Champion,
        AbilityKeyword.Magic,
        AbilityKeyword.Weapon,
      ],
      distance: [
        FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 4, within: 1 }),
      ],
      target: 'All enemies and objects',
      cost: 9,
      sections: [
        ...
        FactoryLogic.createAbilitySectionField({
          name: 'Special',
          effect:
            'You can change the damage type to be a type that your champion deals on their stat block.',
        }),
      ],
    }),
    FactoryLogic.createAbility({
