          ...
          features: [
            ...
            FactoryLogic.feature.createAbility({
              ability: FactoryLogic.createAbility({
                ...
                distance: [
                  FactoryLogic.distance.create({ type: AbilityDistanceType.Aura, value: 5 }),
                ],
          ...
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionSpend({
                repeatable: true,
                effect:
                  'You can trigger this ability when a target uses an ability that has a Heroic Resource cost of 3 + each additional drama spent.',
              }),
            ],
          }),
        }),
                  ...
                  sections: [
                    ...
                    FactoryLogic.createAbilitySectionRoll(
                      FactoryLogic.createPowerRoll({
                        characteristic: [Characteristic.Presence],
                        tier1:
                          '5 corruption damage; M < [weak], pull 1 toward the center of the area',
                        tier2:
                          '9 corruption damage; M < [average], pull 2 toward the center of the area',
                        tier3:
                          '12 corruption damage; M < [strong], pull 3 toward the center of the area',
                      }),
                    ),
                  ],
                }),
