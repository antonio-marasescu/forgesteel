  ...
  featuresByLevel: [
    {
      ...
      features: [
        ...
        FactoryLogic.feature.create({
          ...
          name: 'Mighty Leaps',
          description:
            'You can’t obtain lower than a tier 2 outcome on any Might test made to jump.',
        }),
...
Primordial power remains until you spend it.`,
  ...
  abilities: [
    ...
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionSpend({
          repeatable: true,
          effect:
            'While you are winded, this ability deals an extra 1d6 damage for each ferocity spent. While you are dying, it deals an extra 1d10 damage for each ferocity spent. In either case, you lose 1d6 Stamina after making this strike.',
        }),
      ],
    }),
    FactoryLogic.createAbility({
    ...
    FactoryLogic.createAbility({
      ...
      target: 'Self',
      cost: 7,
      sections: [FactoryLogic.createAbilitySectionText('You gain 20 temporary Stamina.')],
    }),
    FactoryLogic.createAbility({
      id: 'fury-ability-16',
