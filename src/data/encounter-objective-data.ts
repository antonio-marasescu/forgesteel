...
* In a battle against a solo creature, the creature flees or surrenders when reduced to a quarter of their Stamina or less and after using all their villain actions.`,
    failureCondition:
      'The heroes gain no Victories if they are killed, captured, flee, or otherwise fail to defeat their foes.',
    victories:
      'If the heroes achieve success, they gain 1 Victory for an easy or standard encounter, or 2 Victories for a hard or extreme encounter.',
  };
...
* **Held**: The thing is possessed by an enemy. Perhaps it’s in their pocket or, if the thing is a weapon or implement, the enemy might be using it.`,
    ...
    failureCondition:
      'The heroes gain no Victories if the thing is destroyed or remains in the enemies’ hands.',
    victories:
...
* **Multiple**: There are multiple things, all of which must be destroyed. Divide the thing’s stamina between all of them.`,
    ...
    failureCondition:
      'The heroes gain no Victories if the thing is not destroyed and remains in the enemies’ hands.',
    victories:
      'The heroes gain Victories according to the encounter’s difficulty after being adjusted for this objective. They earn 1 Victory for an easy or standard encounter or 2 for a hard encounter.',
  };
...
During an encounter, potential allies must be won over and freed from captivity before they become allies. This requires success on a **hard Presence test** made as a maneuver. Potential allies otherwise flee for the nearest exit on their turns.`,
    ...
    failureCondition:
      'The heroes gain no Victories if half or more of the allies are dead or captured.',
    victories:
...
At the start of each round, any minion that was killed during the last round is replaced by a reinforcement. The Director chooses their position, which can’t be within 5 squares of the ward, the destination, or any hero.`,
    ...
    failureCondition:
      'If the ward is reduced to 0 Stamina or is prevented from reaching their destination, the heroes gain no Victories.',
    victories:
...
Reinforcements appear at least 10 squares from the defensive position.`,
    difficultyModifier:
      'A Hold Them Off encounter’s difficulty is determined by the creatures present for the battle at the beginning of the first round of combat. Don’t count reinforcements toward the difficulty. The encounter difficulty is one step harder if the encounter duration is 5 rounds or greater.',
    successCondition:
    ...
    failureCondition:
      'The heroes earn now Victories if a number of creatures equal to or greater than their number get passed the defensive position.',
    victories:
...
Often, a defensive position grants bonuses to its defenders. The approach to the position might be narrow, over difficult terrain, or require climbing, or anyone inside the position might have the benefit of higher ground against anyone outside it.`,
    difficultyModifier:
      'An Assault the Defenses encounter’s difficulty is one stage harder if the defensive position grants two or more bonuses to its defenders.',
    successCondition:
      'The heroes win when at least one hero and none of their enemies have been in the defensive position for four consecutive turns.',
...
For more difficult encounters, performing a task may require a successful test.`,
    ...
    successCondition:
      'The heroes win if they reach the end of the encounter duration with 1 or 0 failures.',
    failureCondition:
      'The heroes gain no Victories and the can’t complete the action if they accumulate 2 or more failures during the encounter duration.',
    victories:
