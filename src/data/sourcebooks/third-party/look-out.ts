...
You lose any remaining spark at the end of the encounter.`,
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            description:
              'As an ally attacks, you harness a bit of arcane energy to grant them a decisive advantage.',
            ...
            sections: [
              FactoryLogic.createAbilitySectionText(
                'Apply one Stoke the Flame effect from your talisman kit granted by the Tinderbox feature.',
              ),
              FactoryLogic.createAbilitySectionField({
                name: 'Inner Flame',
                effect:
                  'Once per round, you can spend 1 spark to use Stoke the Flame targeting yourself instead of an ally as a free triggered action. You can use Stoke the Flame this way even if you are dazed.',
              }),
            ],
          }),
        }),
...
As part of the maneuver, you can additionally stand up if you are prone.`,
  ...
  abilities: [
    FactoryLogic.createAbility({
      ...
      description:
        'You dart from skirmish to skirmish leaving an ephemeral doppelganger of fire in your wake.',
    ...
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'A blinded creature has line of effect only to creatures and objects within 2 squares of them.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'A burning target takes 1d6 fire damage at the start of each of their turns until the condition ends.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'An object you target must be your size or smaller. The target takes fire damage equal to the number of squares they are pushed. Squares the target is forced from as part of this ability become difficult terrain for enemies.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'Until the end of the encounter, whenever the target takes damage, all adjacent enemies take 2 fire damage.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      description:
        'Embers and ash rise and coalesce into a solid mass, honed to an edge and ready to command.',
      type: FactoryLogic.type.createManeuver(),
      keywords: [AbilityKeyword.Magic, AbilityKeyword.Ranged],
      distance: [FactoryLogic.distance.createRanged(5)],
      target: 'Special',
...
At the start of your turn while the sword is summoned, as a free maneuver, you can move the sword up to your speed.`),
    ...
    FactoryLogic.createAbility({
      ...
      sections: [
        FactoryLogic.createAbilitySectionText(
          'Until the end of the encounter, targets of your Stoke the Flame ability gain a 2 aura until the end of the round. Enemies within the aura take a bane on power rolls.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      sections: [
        FactoryLogic.createAbilitySectionText(
          'Until the end of the encounter, targets of your Stoke the Flame ability gain a 2 aura until the end of the round. When targets of this ability within the aura make a power roll (including on the ability that triggered Stoke the Flame) and at least one of the d10s rolled is a 1, they can reroll one d10. Additionally, targets of this ability in the aura automatically succeed saving throws to end the dazed condition.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      sections: [
        FactoryLogic.createAbilitySectionText(
          'Until the end of the encounter, targets of your Stoke the Flame ability gain a 2 aura until the end of the round. Targets of this ability who end their turn within the aura gain one surge and their next strike deals extra fire damage equal to your Reason score.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
  ...
  subclasses: [
    {
      ...
      name: 'Flameweaver',
      description:
        'You weave through the battlefield from skirmish to skirmish like a thread in the wind. Your power guides you to where you are needed most.',
      featuresByLevel: [
        {
          level: 1,
          features: [
            ...
            FactoryLogic.feature.createPackageContent({
              ...
              name: 'Wildfire',
              description:
                'While you are enkindled, whenever you shift or teleport, the distance of the movement is increased by 1 and one ally adjacent to you at the beginning of the movement can teleport to an unoccupied space adjacent to you at the end of the movement.',
              tag: 'Enkindle',
            }),
          ],
        },
        {
          ...
          features: [
            FactoryLogic.feature.create({
              ...
              description:
                'You can swim, climb, or otherwise move along reflective surfaces, such as the surface of a river or up a wall of metal, at full speed.',
            }),
              ...
              options: [
                {
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        FactoryLogic.createAbilitySectionText(
                          'Teleport to an unoccupied space adjacent the target. You or the target can use a signature ability and you or the target can spend a Recovery, in either order. Whomever spends a Recovery in this way gains 2 surges.',
                        ),
                      ],
                    }),
                  }),
                ...
                },
                {
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        FactoryLogic.createAbilitySectionText(
                          'Use a signature ability. After you use the ability, you can shift up to your speed. At the end of your movement, you or an adjacent ally can make a melee free strike.',
                        ),
                      ],
                    }),
                  }),
    ...
    },
    {
      ...
      name: 'Hexblaze',
      description:
        'You are an eruption, and the battlefield will burn to ash. The explosive force of your power shatters any hope of victory for your enemies.',
      featuresByLevel: [
        {
          level: 1,
          features: [
            ...
            FactoryLogic.feature.createPackageContent({
              ...
              name: 'Fan the Flame',
              description:
                'While you are enkindled, the first time in a round that you take damage, reduce the damage by your Agility score and gain 1 surge.',
              tag: 'Enkindle',
            }),
          ],
        },
        {
          ...
          features: [
            ...
            FactoryLogic.feature.create({
              ...
              name: "St. Elmo's Fire",
              description:
                'During and shortly after a thunderstorm, you glow with a faint blue flame and you have an edge on tests that use the Navigate skill.',
            }),
            FactoryLogic.feature.createChoice({
              id: '7kh47fRjTepke93l',
              ...
              options: [
                {
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      description:
                        'The hue of your fire entrances you, to the mortal detriment of the Undermind’s enemies.',
                      type: FactoryLogic.type.createManeuver(),
                      keywords: [AbilityKeyword.Magic],
                      distance: [FactoryLogic.distance.createSelf()],
                      target: 'Self',
...
Changing the color of your flames requires the use of this ability again.`),
                  ...
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        ...
                        FactoryLogic.createAbilitySectionText(
                          'Gain 1 surge that you can use immediately.',
                        ),
                        FactoryLogic.createAbilitySectionSpend({
                          effect:
                            'For each enemy you kill with this ability, regain Stamina equal to 5 + your Reason score.',
                          value: 2,
                        }),
                      ],
                    }),
    ...
    },
    {
      ...
      name: 'Smokewight',
      description:
        'You are at once everywhere and nowhere. You slip through the grasp of your foes and you cannot be pinned down.',
      featuresByLevel: [
        {
          level: 1,
          features: [
            ...
            FactoryLogic.feature.createPackageContent({
              ...
              name: 'Backdraft',
              description:
                'While you are enkindled, when you pull a creature, you ignore their stability, and when you force move a creature, the distance of the move gains a +1 bonus.',
              tag: 'Enkindle',
            }),
          ],
        },
        {
          ...
          features: [
            FactoryLogic.feature.create({
              ...
              description:
                'In combat, you can’t suffocate and you gain an edge on the Escape Grab maneuver. Out of combat, you can hold your breath for a number of minutes equal to twice your Reason score, and while you hold your breath, you can turn your body to dense smoke. While in this form, you move through gaps as if you were size 1T, you can hover, and you don’t take damage from falling.',
            }),
            FactoryLogic.feature.createChoice({
              id: 'cS6etUqiiyIoRNd4',
              ...
              options: [
                {
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      name: 'Choking Soot',
                      description:
                        'The blackened sky grants you a vision: your foes reduced to ash.',
                      type: FactoryLogic.type.createMain(),
                      keywords: [AbilityKeyword.Magic],
                      distance: [FactoryLogic.distance.createSelf()],
                      target: 'Self',
                      ...
                      sections: [
                        FactoryLogic.createAbilitySectionText(
                          'Until the end of the encounter, soot falls from the sky. You and each ally gain an edge on tests that use the Hide skill. Enemies have fire weakness 3. If an enemy is grabbed, they have fire weakness 7.',
                        ),
                      ],
                    }),
                  }),
                  ...
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        ...
                        FactoryLogic.createAbilitySectionText(
                          'You can shift up to your speed. If you end the movement with cover or concealment, you are hidden.',
                        ),
                        FactoryLogic.createAbilitySectionSpend({
                          effect:
                            'For every additional 2 spark you spend, the potency is increased by 1 and the size of the burst is increased by 1.',
                          value: 2,
                          repeatable: true,
                        }),
                      ],
...
const hawthorn: Kit = {
  ...
  name: 'Hawthorn',
  description:
    'Your talismans grant you the ability to ensnare, burden, and wrest vitality out of your victims.',
  type: 'Kiln',
  armor: [],
  weapon: [],
  stamina: 0,
  ...
  features: [
    FactoryLogic.feature.createAbility({
      ability: FactoryLogic.createAbility({
        ...
        sections: [
          FactoryLogic.createAbilitySectionText(
            'Until the start of your next turn, your stability is increased by 2. You and allies in the area each gain 1 surge and can spend a Recovery.',
          ),
          FactoryLogic.createAbilitySectionField({
            name: 'Enkindled',
          ...
          FactoryLogic.createAbilitySectionSpend({
            effect:
              'For each spark you spend, the burst’s size is increased by 1 and your stability is further increased by 1 until the start of your next turn, which increases the temporary Stamina gained by affected allies.',
          }),
        ],
      }),
    }),
      ...
      ability: FactoryLogic.createAbility({
        ...
        sections: [
          ...
          FactoryLogic.createAbilitySectionField({
            name: 'Enkindled',
            effect:
              'The pull effect on tier 2 and tier 3 outcomes changes to vertical pull and the distance of the pull is increased by your Reason.',
          }),
        ],
      }),
    }),
...
const hazel: Kit = {
  ...
  name: 'Hazel',
  description:
    'Your talismans grant you the ability to anticipate the future and discern illusion from reality.',
  type: 'Kiln',
  armor: [],
  weapon: [],
  stamina: 0,
  ...
  features: [
    FactoryLogic.feature.createAbility({
      ability: FactoryLogic.createAbility({
        ...
        sections: [
          FactoryLogic.createAbilitySectionText(
            'The next strike against each target gains an edge and each target is additionally I < [weak] weakened (save ends).',
          ),
          FactoryLogic.createAbilitySectionField({
            name: 'Enkindled',
          ...
          FactoryLogic.createAbilitySectionSpend({
            effect:
              'For each spark you spend, the burst’s size is increased by 1 and the potency is increased by 1.',
          }),
        ],
      }),
    }),
    FactoryLogic.feature.createAbility({
      ability: FactoryLogic.createAbility({
        ...
        sections: [
          FactoryLogic.createAbilitySectionText(
            'Targets of this ability do not need to be within line of effect. Hidden enemies in the area are automatically revealed.',
          ),
          FactoryLogic.createAbilitySectionRoll(
            FactoryLogic.createPowerRoll({
              characteristic: Characteristic.Reason,
          ...
          FactoryLogic.createAbilitySectionField({
            name: 'Enkindled',
            effect:
              'You can teleport instead of shift, and you do not need line of effect to your destination. If you teleport to a space adjacent to any allies, one of the allies can make a free strike.',
          }),
        ],
      }),
    }),
...
const rosewood: Kit = {
  ...
  name: 'Rosewood',
  description:
    'Your talismans grant you the ability to amplify and echo your allies, and terrify your enemies.',
  type: 'Kiln',
  armor: [],
  weapon: [],
  stamina: 0,
  ...
  features: [
    FactoryLogic.feature.createAbility({
      ability: FactoryLogic.createAbility({
        ...
        name: 'Speed of Sound',
        description:
          'In a clap of thunder, you flash across the battlefield, your poised form burned into the eyes of your foes.',
        type: FactoryLogic.type.createManeuver(),
        keywords: [AbilityKeyword.Magic, AbilityKeyword.Area],
        distance: [FactoryLogic.distance.create({ type: AbilityDistanceType.Burst, value: 1 })],
        target: 'All enemies',
        sections: [
          FactoryLogic.createAbilitySectionText(
            'You teleport up to 3 squares. In the square you teleport from, you leave an afterimage that lasts until the end of the round. All targets are taunted by the afterimage. You can push one creature you are adjacent to after you teleport a number of squares equal to the distance you teleported.',
          ),
          FactoryLogic.createAbilitySectionField({
            name: 'Enkindled',
            effect:
              'Until the end of the round, as a free triggered action, after you use an ability, you can swap places with your afterimage.',
          }),
          FactoryLogic.createAbilitySectionSpend({
    ...
    FactoryLogic.feature.createAbility({
      ability: FactoryLogic.createAbility({
        ...
        name: 'Resonate',
        description:
          'Your talismans imbue you with the resonance of a hollow trunk reaching up from the Undermind.',
        type: FactoryLogic.type.createMain(),
        keywords: [AbilityKeyword.Area, AbilityKeyword.Magic],
        distance: [FactoryLogic.distance.create({ type: AbilityDistanceType.Burst, value: 2 })],
        target: 'All enemies',
  ...
  data: {
    features: [
      FactoryLogic.feature.create({
        ...
        name: 'Tendrils of the Undermind',
        description:
          'Your connection with the Undermind lets you share senses with it. You can search for hidden creatures as a free maneuver once on each of your turns. Creatures within distance of your Stoke the Flame ability are automatically found when you search.',
      }),
      FactoryLogic.feature.createAbility({
        ability: FactoryLogic.createAbility({
          id: 'J9Q4GZyz56Qqxw1e',
          ...
          sections: [
            FactoryLogic.createAbilitySectionText(
              'Until the end of the round, your Stoke the Flame ability gains a distance bonus of +5 and you don’t need line of effect to target allies with your Stoke the Flame ability.',
            ),
          ],
        }),
      }),
