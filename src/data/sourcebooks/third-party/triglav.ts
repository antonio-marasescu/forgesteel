              ...
              },
              {
                feature: FactoryLogic.feature.createAbility({
                  ability: FactoryLogic.createAbility({
                    ...
                    target: 'All allies in the area',
                    cost: 'signature',
                    sections: [FactoryLogic.createAbilitySectionText('Each target gains a surge.')],
                  }),
                }),
                value: 1,
              },
            ...
            FactoryLogic.feature.createAbility({
              ability: FactoryLogic.createAbility({
                ...
                sections: [
                  ...
                  FactoryLogic.createAbilitySectionSpend({
                    effect:
                      'You gain concealment until the start of your next turn and automatically become hidden.',
                  }),
                ],
              }),
            }),
        ...
        FactoryLogic.createAbility({
          ...
          sections: [
            ...
            FactoryLogic.createAbilitySectionField({
              name: 'Shroud',
              effect:
                'After you teleport, you can use a signature ability or Drink Most Exquisite as a free maneuver instead of the free strike.',
            }),
          ],
        }),
        FactoryLogic.createAbility({
...
Some of your abilities have the Spore keyword. Abilities with the Spore keyword don't need line of effect to affect a target within distance.`,
            ...
            FactoryLogic.feature.createAbility({
              ability: FactoryLogic.createAbility({
                ...
                sections: [
                  ...
                  FactoryLogic.createAbilitySectionSpend({
                    effect:
                      'After the size of your aura increases, each enemy in the area gains damage weakness equal to your echelon until the end of their next turn.',
                  }),
                ],
              }),
            }),
            FactoryLogic.feature.createAbility({
              ability: FactoryLogic.createAbility({
                ...
                description:
                  'Upon spotting danger, you release more spores to disorient the attacker.',
                ...
                sections: [
                  ...
                  FactoryLogic.createAbilitySectionSpend({
                    effect:
                      'Each enemy in the area takes poison damage equal to your Presence score + your virulence.',
                  }),
                ],
              }),
            }),
        ...
        FactoryLogic.createAbility({
          ...
          sections: [
            ...
            FactoryLogic.createAbilitySectionField({
              name: 'Virulence 3',
              effect:
                'Each target can end one condition or effect on them that is ended by a saving throw or that ends at the end of their turn.',
            }),
            FactoryLogic.createAbilitySectionField({
              name: 'Virulence 5',
        ...
        FactoryLogic.createAbility({
          ...
          sections: [
            ...
            FactoryLogic.createAbilitySectionField({
              name: 'Virulence 3',
              effect:
                "The distance of the appendage's strike increases to 2 and in addition to dealing damage and making creatures infected, it can also slide the target up to a number of squares equal to the tier outcome of your power roll.",
            }),
            FactoryLogic.createAbilitySectionField({
              name: 'Virulence 5',
              effect: `
        ...
        FactoryLogic.createAbility({
          ...
          sections: [
            ...
            FactoryLogic.createAbilitySectionField({
              name: 'Virulence 4',
              effect:
                'Each target gains 2 surges instead of 1, and the bonus to speed lasts until the end of the encounter for them.',
            }),
          ],
        }),
        FactoryLogic.createAbility({
