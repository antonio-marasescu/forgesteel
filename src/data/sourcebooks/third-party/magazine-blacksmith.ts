  ...
  features: [
    FactoryLogic.feature.createAbility({
      ability: FactoryLogic.createAbility({
        ...
        description:
          'You throw yourself at an enemy and try to put the fear of the Gods into them.',
        type: FactoryLogic.type.createMain(),
        keywords: [
...
export const blacksmith: Sourcebook = {
  ...
  description:
    "A selection of content from the [Blacksmith's Guild](https://tabletopnonsenseverse.myshopify.com/).",
