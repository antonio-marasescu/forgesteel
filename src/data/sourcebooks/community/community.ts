        ...
        FactoryLogic.feature.createHeroicResource({
          ...
          gains: [
            ...
            },
            {
              ...
              trigger:
                'The first time in an encounter you or an ally spends 3 or more surges on a single ability to increase the damage',
              value: '1d3',
            },
            {
              tag: 'ally-surge-potency',
              trigger:
                'The first time in an encounter you or an ally spends 2 surges on a single ability to increase the potency',
              value: '1d3',
            },
          ],
        }),
...
Additionally, you add your level to project rolls to craft projects and whenever you convert Victories into XP, you gain 5 project points for every point of XP you gain.`,
	...
	* The target gains one additional surge.`,
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            sections: [
              ...
              FactoryLogic.createAbilitySectionText(
                'When you make this strike, choose the damage type from one of the following options: acid, cold, fire, lightning, poison, or sonic.',
              ),
            ],
          }),
        }),
        FactoryLogic.feature.createChoice({
          ...
          name: 'Upgrades',
          description:
            'You have taken to making custom modifications to your equipment to enhance your statistics. You can choose one of the following upgrades. You can change your upgrade by tinkering with your equipment as a respite activity.',
          options: [
            {
              feature: FactoryLogic.feature.createMultiple({
                id: 'laR6VpDj9UbeEQIZ',
...
If you have a kit, you can’t take this upgrade.`,
            ...
            },
            {
              feature: FactoryLogic.feature.createAbilityDamage({
                ...
                description:
                  'You have modified your weapons with auxillary batteries. You gain a +1 rolled damage bonus with magic abilities.',
            ...
            },
            {
              feature: FactoryLogic.feature.createAbilityDistance({
                ...
                description:
                  'You have detailed lenses to increase your aim. You gain a +2 bonus to the distance of your ranged magic abilities.',
                keywords: [AbilityKeyword.Magic, AbilityKeyword.Ranged],
                value: 2,
              }),
              value: 1,
            },
            {
              feature: FactoryLogic.feature.createMultiple({
                ...
                description:
                  'You have imbued your armor with servos. You gain a +1 bonus to speed and to the distance you shift when you take the Disengage move action.',
                features: [
                  FactoryLogic.feature.createBonus({
                    id: 'viZ60LWZ30lRVtR5',
                    name: 'Speed',
            ...
            },
            {
              feature: FactoryLogic.feature.createMultiple({
                ...
                description:
                  'Your armor has been modified to increase its center mass and toughness. You gain a +6 bonus to Stamina, and this bonus increases by 6 at 4th, 7th, and 10th levels. Additionally, you gain a +1 bonus to stability.',
                features: [
                  FactoryLogic.feature.createBonus({
                    id: 'qiJTWUSbPvne14QA',
                    name: 'Stamina',
        ...
        FactoryLogic.feature.createChoice({
          ...
          description:
            'Your magic allows you to enchant your equipment to provide additional protection. Choose one of the following wards. You can change your ward along with your Upgrade (see Upgrade) by tinkering as a respite activity.',
          options: [
            {
              feature: FactoryLogic.feature.create({
                id: 'DbX3XdscebqQP9KQ',
                ...
                description:
                  'Your ward reacts to harm to help you escape danger. Whenever an adjacent creature deals damage to you, you can slide yourself a number of squares equal to your Reason score after the damage is dealt.',
              }),
              value: 1,
            },
            {
              feature: FactoryLogic.feature.createAbility({
                ability: FactoryLogic.createAbility({
                  ...
                  type: FactoryLogic.type.createTrigger(
                    'The first time each round you take acid, cold, fire, poison, sonic, or lighting damage.',
                  ),
                  distance: [FactoryLogic.distance.createSelf()],
                  target: 'Self',
                  sections: [
                    FactoryLogic.createAbilitySectionText(
                      'You gain temporary stamina equal to your Reason score.',
                    ),
                  ],
                }),
              }),
            ...
            },
            {
              feature: FactoryLogic.feature.createAbility({
                ability: FactoryLogic.createAbility({
                  ...
                  type: FactoryLogic.type.createTrigger(
                    'A creature targets you with an ability that requires a power roll and and has an edge.',
                  ),
                  sections: [
                    FactoryLogic.createAbilitySectionText(
                      'You inflict a bane on triggering power roll.',
                    ),
                  ],
                }),
              }),
            ...
            },
            {
              feature: FactoryLogic.feature.create({
                ...
                description:
                  'At the start of your turn, you can make a saving throw against one effect that can be ended on a saving throw.',
              }),
              value: 1,
            },
          ],
    ...
    },
    {
      ...
      features: [
        FactoryLogic.feature.create({
          ...
          description:
            'As a respite activity, you can create a number of trinkets equal to your Reason score that last until you use this feature again, or you die. The total project value of the trinkets you create cannot exceed your level x 50. You must have the project source for these trinkets, but you may ignore the Item prerequisite at your Director’s discretion.',
        }),
        FactoryLogic.feature.createClassAbilityChoice({
          id: 'magewright-3-2',
          cost: 7,
  ...
  abilities: [
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'A jolted creature cannot take triggered actions, free triggered actions, or maneuvers.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      keywords: [AbilityKeyword.Area, AbilityKeyword.Magic],
      distance: [
        FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 3, within: 1 }),
      ],
      target: 'Each enemy in the area',
      cost: 'signature',
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'While burning, a target takes fire damage equal to your Reason score at the start of its turn.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'While slowed, targets cannot use triggered actions.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      type: FactoryLogic.type.createMain(),
      keywords: [AbilityKeyword.Melee, AbilityKeyword.Magic, AbilityKeyword.Strike],
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'You can negate a bane on the power roll, or reduce a double bane to a bane.',
        ),
        FactoryLogic.createAbilitySectionSpend({
    ...
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'While weakened this way, whenever you or an ally uses an ability that incorporates 1 or more surges against the target, they gain 1 additional surge they must use on the ability.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      distance: [FactoryLogic.distance.createMelee(), FactoryLogic.distance.createRanged(10)],
      target: 'One creature or object',
      cost: 'signature',
      sections: [
        FactoryLogic.createAbilitySectionRoll(
        ...
        FactoryLogic.createAbilitySectionText(
          'You gain a surge for each natural odd number on your power roll. If you roll doubles, you gain 3 surges instead.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'For each square you push the target, they take 1 sonic damage.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      distance: [
        FactoryLogic.distance.create({ type: AbilityDistanceType.Burst, value: 2, within: 10 }),
      ],
      target: 'Each enemy in the area',
      cost: 'signature',
      sections: [
    ...
    FactoryLogic.createAbility({
      ...
      sections: [
        FactoryLogic.createAbilitySectionText(
          'You gain 2 surges and each target takes lightning damage equal to twice your Reason score. Until the start of your next turn, any creature within 2 squares that strikes you takes lightning damage equal to twice your Reason score.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
      distance: [
        FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 2, within: 10 }),
      ],
      target: 'Each enemy in the area',
      cost: 3,
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'While dazed, targets treat other creatures as though they have concealment and do not count as observers.',
        ),
        FactoryLogic.createAbilitySectionSpend({
          effect: 'You increase the size of the area by 1.',
        }),
    ...
    FactoryLogic.createAbility({
      ...
      sections: [
        FactoryLogic.createAbilitySectionText(
          'If you target an ally, they gain temporary Stamina equal to three times your Reason score, and they can end one effect on them that is ended by a saving throw or that ends at the end of their turn. If you target an enemy, you make a power roll.',
        ),
        FactoryLogic.createAbilitySectionRoll(
          FactoryLogic.createPowerRoll({
            characteristic: Characteristic.Reason,
    ...
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'This forced movement ignores the target’s stability, and if this forced movement causes the target to slam into an enemy, the target takes no damage from the collision and the enemy takes extra damage equal to the number of squares the target moved. The target then pushes the enemy they collide with a number of squares equal to the distance the target moved.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'Each enemy within 2 squares of at least 1 target takes lightning damage equal to twice your Reason score.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
...
* The next ability roll a target makes before the end of the encounter has an edge.`),
      ...
      sections: [
        FactoryLogic.createAbilitySectionRoll(
          FactoryLogic.createPowerRoll({
            ...
            tier1:
              '2 acid damage; M < [weak], the target has damage weakness equal to your Reason score (save ends)',
            tier2:
              '5 acid damage; M < [average], the target has damage weakness equal to your Reason score (save ends)',
            tier3:
              '7 acid damage; M < [strong], the target has damage weakness equal to your Reason score (save ends)',
          }),
        ),
        FactoryLogic.createAbilitySectionText(
          'The gas remains in the area until the end of the end of your next turn. Any creature who ends their turn in the area takes acid damage equal to your Reason score.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
    ...
    FactoryLogic.createAbility({
      ...
      description:
        'The target disappears for a brief moment, behind a practical application of light.',
      type: FactoryLogic.type.createManeuver(),
      keywords: [AbilityKeyword.Magic, AbilityKeyword.Ranged],
      distance: [FactoryLogic.distance.createRanged(10)],
      target: 'Self or one ally',
      ...
      sections: [
        FactoryLogic.createAbilitySectionText(
          'The target becomes invisible and hidden, even if observed, until they use an ability. Until the end of the encounter or you are dying, the target may use a free maneuver once on their turn to regain the effects of this ability.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
  ...
  subclasses: [
    {
      ...
      name: 'Automancer',
      description:
        'Automancers focus on the creation of servitor constructs that serve as shields and weapons for themselves and their allies.',
      featuresByLevel: [
        {
          level: 1,
          features: [
...
**Leveled Items.** When you wield a leveled weapon, armor, implement, or other leveled item, your servitor gains the benefits of the magic treasure as if they were wielding it. As is true with any character, both of you only benefit from a wieldable magic weapon or armor if its keywords match your kit. Your servitor can also wield one leveled treasure independently of you, as long as its keywords match the kit of your servitor.`,
                  ...
                  options: [
                    FactoryLogic.createSummon({
                      monster: FactoryLogic.createMonster({
                        ...
                        level: 1,
                        role: FactoryLogic.createMonsterRole(
                        ...
                        features: [
                          FactoryLogic.feature.createAbility({
                            ability: FactoryLogic.createAbility({
                              ...
                              name: 'Kit Attack!',
                              type: FactoryLogic.type.createMain(),
                              keywords: [AbilityKeyword.Weapon, AbilityKeyword.Servitor],
                              distance: [FactoryLogic.distance.createSpecial('Special')],
                              target: 'Special',
                              sections: [
                                FactoryLogic.createAbilitySectionText(
                                  'The servitor uses the signature ability of their equipped kit.',
                                ),
                                FactoryLogic.createAbilitySectionSpend({
                                  effect:
                                    'The servitor can use this ability once per round as a free maneuver.',
                                  value: 5,
                                }),
                              ],
                            }),
                          ...
                          FactoryLogic.feature.createAbility({
                            ability: FactoryLogic.createAbility({
                              ...
                              description:
                                '*Your servitor moves to interdict a foe, and keep its allies safe.*',
                              ...
                              sections: [
                                FactoryLogic.createAbilitySectionText(
                                  '2 + M damage; until the end of your next turn, enemies are weakened while adjacent to the servitor.',
                                ),
                                FactoryLogic.createAbilitySectionSpend({
                                  effect:
                                    'When an enemy would be weakened by this ability, they are taunted instead.',
                                }),
                              ],
                            }),
                          }),
                          ...
                          FactoryLogic.feature.create({
                            ...
                            name: 'Remote Link',
                            description:
                              'Whenever you use a magewright ability, you can do so as if you were in the servitor’s space. Doing so counts as the servitor’s action or maneuver for the turn.',
                          }),
                          FactoryLogic.feature.create({
                            id: 'n6QXX5WicXiE3G5R',
                            name: 'Protector',
                            description:
                              'The servitor gains a surge when they deal damage to a creature adjacent to you or an ally.',
                          }),
                        ],
                      }),
                      cost: 0,
                        ...
                        features: [
                          ...
                          FactoryLogic.feature.createAbility({
                            ability: FactoryLogic.createAbility({
                              ...
                              description:
                                '*Powerful tensors allow your servitor to bring a target down.*',
                              type: FactoryLogic.type.createManeuver({ freeStrike: true }),
                              keywords: [
                                AbilityKeyword.Melee,
                                AbilityKeyword.Servitor,
                              ...
                              sections: [
                                FactoryLogic.createAbilitySectionText(
                                  '2 + A damage; M< [average], prone.',
                                ),
                                FactoryLogic.createAbilitySectionSpend({
                                  effect:
                                    'The servitor can jump up to their speed before using this ability. If they jump at least 1 square in this way, a target who is M < [strong] is prone.',
                                }),
                              ],
                            }),
                          }),
                          ...
                          FactoryLogic.feature.create({
                            ...
                            name: 'Lithe',
                            description:
                              'When the servitor takes the Advance move action or takes the Charge action, as part of the movement they can jump up to their speed in any direction, including vertically.',
                          }),
                        ],
                      }),
                      cost: 0,
                        ...
                        features: [
                          ...
                          FactoryLogic.feature.createAbility({
                            ability: FactoryLogic.createAbility({
                              ...
                              name: 'Energy Blast',
                              description:
                                '*Your servitor releases a capacitor of stored energy into a focused stream.*',
                              type: FactoryLogic.type.createManeuver({ freeStrike: true }),
                              keywords: [
                                AbilityKeyword.Servitor,
                                AbilityKeyword.Area,
                              ...
                              sections: [
                                FactoryLogic.createAbilitySectionText(
                                  'M damage of the attuned damage type (see Attuned).',
                                ),
                                FactoryLogic.createAbilitySectionSpend({
                          ...
                          FactoryLogic.feature.create({
                            ...
                            name: 'Attuned',
                            description:
                              'When you gain this servitor, choose a damage type from acid, cold, fire, lightning, poison, or sonic. The servitor is attunedto that damage type, and gains damage immunity equal to 1 + your Reason score against that type. Attuned also affects their other features.',
                          }),
                          FactoryLogic.feature.create({
                            id: 'EAb6hfXtPMotwewB',
                            name: 'Radiator',
                            description:
                              'An enemy that moves adjacent to your servitor, or ends their turn adjacent to them takes M damage of the attuned damage type.',
                          }),
                        ],
                      }),
                      cost: 0,
                        ...
                        features: [
                          ...
                          FactoryLogic.feature.createAbility({
                            ability: FactoryLogic.createAbility({
                              ...
                              name: 'Galvanic Flash',
                              description:
                                '*Your servitor unleashes a jolt of electricity that disrupts the target’s senses.*',
                              type: FactoryLogic.type.createManeuver({ freeStrike: true }),
                              keywords: [
                                AbilityKeyword.Melee,
                                AbilityKeyword.Servitor,
                              ...
                              sections: [
                                FactoryLogic.createAbilitySectionText(
                                  '3 + M lightning damage; I < [average], dazzled (EoT)',
                                ),
                          ...
                          FactoryLogic.feature.create({
                            ...
                            name: 'Lightning Rod',
                            description:
                              'The first time each turn that you or your companion deal lightning damage, you gain a surge.',
                          }),
                        ],
                      }),
                      cost: 0,
                        ...
                        features: [
                          ...
                          FactoryLogic.feature.createAbility({
                            ability: FactoryLogic.createAbility({
                              ...
                              description:
                                '*Your servitor fires a bolt that exposes a critical weakness in a foe.*',
                              type: FactoryLogic.type.createManeuver({ freeStrike: true }),
                              keywords: [
                                AbilityKeyword.Servitor,
                                AbilityKeyword.Weapon,
                              ...
                              sections: [
                                FactoryLogic.createAbilitySectionText(
                                  '2 + M damage and the next ability roll made against the target has an edge.',
                                ),
                                FactoryLogic.createAbilitySectionSpend({
                                  effect:
                                    'The servitor adds their Intuition score to either the damage or the range.',
                                }),
                              ],
                            }),
                          }),
                          ...
                          FactoryLogic.feature.create({
                            ...
                            name: 'Lock On',
                            description:
                              'This servitor’s abilities, as well as magewright abilities used using the remote link feature, ignore cover or concealment.',
                          }),
                        ],
                      }),
                      cost: 0,
                        ...
                        features: [
                          ...
                          FactoryLogic.feature.createAbility({
                            ability: FactoryLogic.createAbility({
                              ...
                              description:
                                '*A hooked grapnel latches onto a target, and reels them in*',
                              type: FactoryLogic.type.createManeuver({ freeStrike: true }),
                              keywords: [
                                AbilityKeyword.Melee,
                                AbilityKeyword.Servitor,
                              ...
                              sections: [
                                FactoryLogic.createAbilitySectionText(
                                  'M damage; pull 3; if the target is pulled adjacent to the servitor, they are M < [average] grabbed',
                                ),
                                FactoryLogic.createAbilitySectionSpend({
                                  effect:
                                    'The target is pulled up to an additional number of squares equal to the servitor’s Might score; M < [strong], grabbed',
                                }),
                              ],
                            }),
                          }),
                          ...
                          FactoryLogic.feature.create({
                            ...
                            name: 'Pully System',
                            description:
                              'The servitor can move at full speed while they have a creature grabbed, no matter the grabbed creature’s size.',
                          }),
                        ],
                      }),
                      cost: 0,
                        ...
                        features: [
                          ...
                          FactoryLogic.feature.createAbility({
                            ability: FactoryLogic.createAbility({
                              ...
                              name: 'Battering Ram',
                              description:
                                '*Your servitor unleashes stored pressure to eject a foe from their position.*',
                              type: FactoryLogic.type.createManeuver({ freeStrike: true }),
                              keywords: [
                                AbilityKeyword.Melee,
                                AbilityKeyword.Servitor,
                              ...
                              sections: [
                                ...
                                FactoryLogic.createAbilitySectionSpend({
                                  effect:
                                    'The target is pushed up to an additional number of squares equal to the servitor’s Might score.',
                                }),
                              ],
                            }),
                          }),
                          ...
                          FactoryLogic.feature.create({
                            ...
                            name: 'Durable',
                            description:
                              'While the servitor is winded, they gain damage immunity equal to their Might score and they ignore damage from the Bleeding condition.',
                          }),
                        ],
                      }),
                      cost: 0,
                        ...
                        features: [
                          ...
                          FactoryLogic.feature.createAbility({
                            ability: FactoryLogic.createAbility({
                              ...
                              description:
                                '*Your servitor slides into a foes blind spot to strike at exposed foes*',
                              type: FactoryLogic.type.createManeuver(),
                              keywords: [
                                AbilityKeyword.Melee,
                                AbilityKeyword.Servitor,
                              ...
                              sections: [
                                FactoryLogic.createAbilitySectionText(
                                  '3 + M damage; the servitor is invisible to the enemy until the end of the servitor’s next turn or the servitor deals damage to the enemy.',
                                ),
                                FactoryLogic.createAbilitySectionSpend({
                                  effect:
                                    'An enemy affected by Insurgent Strike who is M < strong is dazed (EoT).',
                                }),
                              ],
                            }),
                          }),
                          ...
                          FactoryLogic.feature.create({
                            ...
                            name: 'Ambusher',
                            description:
                              'If your servitor ends its turn in cover or concealment, it becomes hidden, even if observed.',
                          }),
                          FactoryLogic.feature.create({
                            id: '36D7a7FRWqWNUAuY',
                            name: 'Skill',
            ...
            FactoryLogic.feature.createAbility({
              ability: FactoryLogic.createAbility({
                ...
                sections: [
                  FactoryLogic.createAbilitySectionText(
                    'Your servitor can shift its speed toward the target. If the servitor ends this movement adjacent to the target, it can swap places with the target, become the target of the triggering attack, and reduce the damage by half.',
                  ),
                  FactoryLogic.createAbilitySectionSpend({
                    effect:
                      'You can spend up to 5 wonder to give it temporary Stamina equal to your Reason score times the number of Wonder you spend in this way.',
                    repeatable: true,
                  }),
                ],
              }),
        ...
        },
        {
          ...
          features: [
            FactoryLogic.feature.create({
              ...
              description:
                'Your servitor gains an edge on any test made to assist another creature with a test. Additionally, if your servitor makes a test to assist a test and gets a tier 1 result, they don’t add a bane to the assisted test.',
            }),
            FactoryLogic.feature.createChoice({
              id: '78uOg9XOaaQr6cMC',
...
When you take a respite activity to change your upgrade or choose a new ward, you can select a new selective function feature for your servitor.`,
              options: [
                {
                  feature: FactoryLogic.feature.create({
                    ...
                    name: 'Steel Defender',
                    description:
                      'Your servitor always treats a save ends effect as an EoT effect and their characteristic scores increase by 1 for the purpose of resisting potencies. It has an edge on Intuition tests.',
                  }),
                  value: 1,
                },
                {
                  feature: FactoryLogic.feature.create({
                    ...
                    name: 'Hunter-Seeker',
                    description:
                      'Your servitor gains a bonus to its speed and a bonus to the number of squares it can shift when it takes the Disengage move action equal to your Reason score. It gains a +2 bonus to its free strikes and its rolled damage bonus. It has an edge on Agility tests.',
                  }),
                  value: 1,
                },
                {
              ...
              options: [
                {
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      type: FactoryLogic.type.createTrigger(
                        'Your start your turn or your servitor takes damage.',
                      ),
                      keywords: [AbilityKeyword.Magic, AbilityKeyword.Servitor],
                      distance: [FactoryLogic.distance.createSpecial('Special')],
                      target: 'Your servitor',
                      cost: 5,
                      sections: [
                        FactoryLogic.createAbilitySectionText(
                          'The servitor can spend any number of Recoveries, can end any effects on them that are ended by a saving throw or that end at the end of their turn, and can stand up if they are prone. Until the end of their next turn, your servitor has a double edge on power rolls.',
                        ),
                      ],
                    }),
                  }),
                  ...
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        ...
                        FactoryLogic.createAbilitySectionText(
                          'While the target is grabbed by your servitor, ability rolls against them gain an edge, and whenever they take rolled damage, they take extra damage equal to twice your Reason score.',
                        ),
                      ],
                    }),
                  }),
    ...
    },
    {
      ...
      name: 'Catalyst',
      description:
        'Catalysts are magewrights who focus on the impermanence of creation, and learn to embrace the benefits of the ephemeral.',
      featuresByLevel: [
        {
          level: 1,
          features: [
            ...
            FactoryLogic.feature.createHeroicResourceGain({
              ...
              tag: 'vocation',
              trigger:
                'The first time each round that a creature uses an elixir or you create an elixir',
              value: '1',
              replacesTags: [],
            }),
            FactoryLogic.feature.createMultiple({
...
Additionally, you can use a maneuver to create an elixir, which can be added to the Elixir Pool, or used immediately by you or an adjacent ally.`,
                ...
                FactoryLogic.feature.createAbility({
                  ability: FactoryLogic.createAbility({
                    ...
                    description: '',
                    type: FactoryLogic.type.createManeuver({
                      qualifiers: ['Once per turn', 'Free Maneuver if target is Self'],
                    }),
                    keywords: [],
                    distance: [
...
* The target can end one effect on them that is ended by a saving throw or that ends at the end of their turn.`),
                ...
                FactoryLogic.feature.createAbility({
                  ability: FactoryLogic.createAbility({
                    ...
                    sections: [
                      FactoryLogic.createAbilitySectionText(
                        'You create two elixirs, which are immediately added to the Elixir Pool.',
                      ),
                    ],
                  }),
                }),
            ...
            FactoryLogic.feature.createAbility({
              ability: FactoryLogic.createAbility({
                ...
                type: FactoryLogic.type.createTrigger(
                  'The target would take damage from an ability that is not psychic or holy damage.',
                ),
                keywords: [AbilityKeyword.Magic, AbilityKeyword.Ranged],
                distance: [FactoryLogic.distance.createRanged(10)],
                target: 'One creature or object',
                sections: [
                  FactoryLogic.createAbilitySectionText(
                    'Before the damage is applied, the target gains damage immunity or weakness (your choice) to one of the following damage types: acid, cold, fire, lightning, poison, or sonic equal to your Reason score (save ends). The triggering damage is then changed to that same damage type.',
                  ),
                  FactoryLogic.createAbilitySectionSpend({
                    effect:
                      'If any effect of the damage has a potency effect, you can increase or decrease the potency by 1.',
                  }),
                ],
              }),
            }),
...
As a maneuver, you can expend project points from the stone and craft any consumable that you have both an item prerequisite and project source for, as long as you have the points available. Additionally, you may craft a 1st echelon consumable of your choice without spending any project points. When you use the stone in this way, you cannot do so again until you finish a respite.`,
            ...
            FactoryLogic.feature.create({
              ...
              description:
                'Whenever you or an ally drinks an elixir from your elixir pool, that creature gains temporary stamina equal to twice your Reason score.',
            }),
            FactoryLogic.feature.createChoice({
              id: 'Gp0o9JhtGKH6MxR4',
              name: '2nd-Level Vocation Ability',
              ...
              options: [
                {
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      name: 'Instant Cement',
                      description:
                        'This toxic tar absorbs nearby moisture to reinforce the hardening process.',
                      type: FactoryLogic.type.createMain(),
                      keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
                      distance: [
                        FactoryLogic.distance.create({
                      ...
                      sections: [
                        ...
                        FactoryLogic.createAbilitySectionText(
                          'The area is considered difficult terrain. The tar remains in the area until the end of the encounter. Any creature who starts their turn in the area and has M < [average] is slowed (save ends). If the target is already slowed, they are instead restrained (save ends).',
                        ),
                      ],
                    }),
                  }),
    ...
    },
    {
      ...
      name: 'Gilder',
      description:
        'Gilders are artisans that fuse magic and metallurgy to inscribe equipment with powerful glyphs.',
      featuresByLevel: [
        {
          level: 1,
          features: [
...
You can choose only one free triggered action option at a time, even if multiple options are triggered by the same effect.`,
            ...
            FactoryLogic.feature.createAbility({
              ability: FactoryLogic.createAbility({
                ...
                name: 'Warding Glyph',
                description:
                  "Defensive wards on your allies' armor activate, shielding them from harm.",
                ...
                sections: [
                  FactoryLogic.createAbilitySectionText(
                    'The damage is halved. If any effect of the damage has a potency effect, you decrease the potency by 1.',
                  ),
                  FactoryLogic.createAbilitySectionSpend({
        ...
        },
        {
          ...
          features: [
            ...
            FactoryLogic.feature.create({
              ...
              name: 'Master Maker',
              description:
                'When you make a project roll for a craft project, you may ignore a single bane before the roll. Additionally, you gain a breakthrough on project rolls to craft if you obtain a natural 18 on the project roll.',
            }),
            FactoryLogic.feature.createChoice({
              id: 'f7uha6QreNsgyU8j',
              name: '2nd-Level Vocation Ability',
              ...
              options: [
                {
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      sections: [
                        FactoryLogic.createAbilitySectionText(
                          'The target avoids any effects associated with the damage that triggered your Warding Glyph ability and can spend a Recovery. Each enemy adjacent to the target is pushed a number of squares equal to twice your Reason score.',
                        ),
                      ],
                    }),
                  }),
                ...
                },
                {
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      description:
                        'When these glyphs activate, your allies become able to act as one.',
                      type: FactoryLogic.type.createManeuver(),
                      keywords: [AbilityKeyword.Magic, AbilityKeyword.Ranged],
                      distance: [FactoryLogic.distance.createRanged(10)],
                      target: 'Two creatures',
...
**Primed Benefit:** Until the end of the encounter, whenever a primed creature uses a Main action, you can spend 1 or more wonder to allow one other primed creature per 1 wonder spent to use a free triggered action to shift up to half their speed and make a free strike.`),
    ...
    },
    {
      ...
      name: 'Magitecht',
      description:
        'Magitechts are tinkerers and inventors who develop experimental devices that can aid themselves and their allies.',
      featuresByLevel: [
        {
          level: 1,
          features: [
            ...
            FactoryLogic.feature.createHeroicResourceGain({
              ...
              tag: 'vocation',
              trigger:
                'The first time each round that a hero activates one of your experimental devices',
              value: '1',
              replacesTags: [],
            }),
            FactoryLogic.feature.create({
...
**Transpositional Matrix.** When you use a signature or heroic ability, you can activate this device to spend 1 surge and teleport a number of squares equal to the magewright’s Reason score before or after the ability.`,
            ...
            FactoryLogic.feature.createAbility({
              ability: FactoryLogic.createAbility({
                ...
                sections: [
                  FactoryLogic.createAbilitySectionText(
                    'You can apply the effect of an additional experimental device to the triggering ability, even if the target doesn’t have the associated device.',
                  ),
                  FactoryLogic.createAbilitySectionSpend({
                    effect:
                      'The target gains two surges, which they can use on the triggering ability. They may spend up to four surges on the triggering attack for extra damage, instead of three.',
                  }),
                ],
              }),
            }),
        ...
        },
        {
          ...
          features: [
            FactoryLogic.feature.create({
              ...
              description:
                'You may apply the benefits of your Devoted Artisan feature to project rolls made to research projects in addition to crafting projects.',
            }),
            FactoryLogic.feature.createAbility({
              ability: FactoryLogic.createAbility({
                id: 'vBOB466iQUzKmvVp',
                ...
                },
                {
                  feature: FactoryLogic.feature.createAbility({
                    ability: FactoryLogic.createAbility({
                      ...
                      description:
                        'You briefly collapse space and time around a foe, redirecting an attack, and shunt them elsewhere.',
                      ...
                      sections: [
                        FactoryLogic.createAbilitySectionText(
                          'Choose an enemy within range, including the triggering enemy. The strike targets that enemy instead. You can teleport the target up to 3 squares, and they are R < Strong dazed until the end of their turn. A target can’t be teleported in a way that would harm them (such as over a cliff), leave them dying, or result in them suffering a condition or other negative effect.',
                        ),
                      ],
                    }),
                  }),
      ...
      features: [
        ...
        FactoryLogic.feature.createAbility({
          ability: FactoryLogic.createAbility({
            ...
            name: 'Enweave',
            description:
              'You weave magic into your weapon, preparing to unleash it with your next strike.',
            type: FactoryLogic.type.createManeuver(),
            keywords: [AbilityKeyword.Magic],
...
You cannot use Enweave more than twice before applying its effect to an ability.`),
  ...
  abilities: [
    FactoryLogic.createAbility({
      ...
      name: 'Aether Lash',
      description:
        'With a flick of your blade, you etch a line of invisible force, preparing to strike.',
      type: FactoryLogic.type.createMain(),
      keywords: [
        AbilityKeyword.Magic,
        AbilityKeyword.Melee,
    ...
    FactoryLogic.createAbility({
      ...
      distance: [
        FactoryLogic.distance.create({ type: AbilityDistanceType.Wall, value: 3, within: 1 }),
      ],
    ...
    FactoryLogic.createAbility({
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionText(
          'If the target is suffering from an effect that is ended by a saving throw, this ability deals an additional 10 damage.',
        ),
      ],
    }),
    FactoryLogic.createAbility({
    ...
    FactoryLogic.createAbility({
      ...
      description:
        'You become lightning, flashing from one place to another, leaving ruin in your wake.',
      type: FactoryLogic.type.createMain(),
      keywords: [
        AbilityKeyword.Area,
        AbilityKeyword.Magic,
              ...
              ability: FactoryLogic.createAbility({
                ...
                sections: [
                  ...
                  FactoryLogic.createAbilitySectionSpend({
                    value: 5,
                    effect:
                      'If used immediately after performing an ability that targets only one enemy, you may repeat that ability at your target destination without needing to spend the base cost as long as it costs 5 balance or fewer.',
                  }),
                ],
              }),
            }),
              ...
              ability: FactoryLogic.createAbility({
                ...
                sections: [
                  ...
                  FactoryLogic.createAbilitySectionSpend({
                    value: 2,
                    effect:
                      'The rune is immediately primed, allowing you to detonate it this turn.',
                  }),
                ],
              }),
            }),
              ...
              ability: FactoryLogic.createAbility({
                ...
                sections: [
                  ...
                  FactoryLogic.createAbilitySectionSpend({
                    value: 2,
                    effect:
                      'Make a melee free strike against the creature that damaged the target.',
                  }),
                ],
              }),
            }),
...
* Your Magic abilities with the Area keyword have the area affected increased by 1. If the area is a line, you increase the size of one dimension, not both.`),
  ...
  abilities: [
      ...
      sections: [
        FactoryLogic.createAbilitySectionRoll(
          FactoryLogic.createPowerRoll({
            characteristic: Characteristic.Presence,
            tier1:
              '3 + P corruption damage; P < [weak], the target takes a bane on their next power roll',
            tier2:
              '5 + P corruption damage; P < [average], the target takes a bane on their next power roll',
            tier3:
              '8 + P corruption damage; P < [strong], the target takes a bane on their next power roll',
          }),
        ),
      ],
    }),
    ...
    FactoryLogic.createAbility({
      ...
      keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
      distance: [
        FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 5, within: 10 }),
      ],
      target: '',
      cost: 5,
      sections: [
      ...
      sections: [
        ...
        FactoryLogic.createAbilitySectionRoll(
          FactoryLogic.createPowerRoll({
            characteristic: Characteristic.Presence,
            tier1:
              'vertical pull 1 towards the portal’s center; I < [weak], vertical pull 3 instead',
            tier2:
              'vertical pull 2 towards the portal’s center; I < [average], vertical pull 4 instead',
            tier3:
              'vertical pull 3 towards the portal’s center; I < [strong], vertical pull 5 instead',
          }),
        ),
        FactoryLogic.createAbilitySectionText(
    ...
    FactoryLogic.createAbility({
      ...
      keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
      distance: [
        FactoryLogic.distance.create({ type: AbilityDistanceType.Wall, value: 10, within: 10 }),
      ],
      target: 'Special',
      cost: 9,
      sections: [
            ...
            FactoryLogic.feature.createAbility({
              ability: FactoryLogic.createAbility({
                ...
                sections: [
                  ...
                  FactoryLogic.createAbilitySectionSpend({
                    effect:
                      'While a target is weakened, they take fire damage at the start of each of their turns equal to your Presence score.',
                  }),
                ],
              }),
            }),
...
| 12 (lvl 4+) | Your Infernal Rebuke’s damage increases to four times your Presence score, and its push increases to 5 squares. |`,
      ...
      abilities: [
        FactoryLogic.createAbility({
          ...
          type: FactoryLogic.type.createTrigger('A creature damages you with a rolled ability.', {
            free: true,
          }),
          keywords: [AbilityKeyword.Magic, AbilityKeyword.Ranged],
          distance: [FactoryLogic.distance.createRanged(10)],
...
| 12 (lvl 4+) | Your Incorporeality’s temporary Stamina increases to four times your Presence score. |`,
      ...
      abilities: [
        FactoryLogic.createAbility({
          ...
          keywords: [AbilityKeyword.Area, AbilityKeyword.Magic, AbilityKeyword.Ranged],
          distance: [
            FactoryLogic.distance.create({ type: AbilityDistanceType.Cube, value: 4, within: 10 }),
          ],
          target: 'All enemies',
          cost: 5,
          sections: [
            ...
            FactoryLogic.feature.createAbility({
              ability: FactoryLogic.createAbility({
                ...
                sections: [
                  ...
                  FactoryLogic.createAbilitySectionSpend({
                    effect:
                      'You additionally slide a grabbed creature a number of squares equal to your Presence score. It remains grabbed if it ends within the Melee distance of this ability.',
                  }),
                ],
              }),
            }),
...
export const community: Sourcebook = {
  ...
  careers: [],
  classes: [magewright, scion, vessel],
  complications: [],
  cultures: [],
  domains: [],
  encounters: [],
