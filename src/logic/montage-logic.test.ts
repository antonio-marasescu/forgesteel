...
describe('getSuccessLimit', () => {
  test.each([
    ...
    'returns the proper success limit for various party sizes and difficulties',
    (difficulty: EncounterDifficulty, numHeroes: number, expectedSuccesses: number) => {
      const montage = {
...
describe('getOutcome', () => {
  test.each([
    ...
    'correctly identifies total successes',
    (difficulty: EncounterDifficulty, numHeroes: number, numSuccesses: number) => {
  ...
  test.each([
    ...
    'correctly identifies partial successes',
    (
  ...
  test.each([
    ...
    'correctly identifies total failures',
    (
      difficulty: EncounterDifficulty,
      numHeroes: number,
      numSuccesses: number,
  ...
  test.each([[EncounterDifficulty.Easy, 5, 4, 4]])(
    'correctly identifies in progress montage tests',
    (
      difficulty: EncounterDifficulty,
      numHeroes: number,
      numSuccesses: number,
