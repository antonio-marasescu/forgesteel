              ...
              sections: [
                FactoryLogic.createAbilitySectionRoll(
                  FactoryLogic.createPowerRoll({
                    ...
                    tier3:
                      '15 damage; M < [strong] slowed and target can’t use triggered actions (save ends)',
                  }),
                ),
                FactoryLogic.createAbilitySectionText(
              ...
              sections: [
                FactoryLogic.createAbilitySectionRoll(
                  FactoryLogic.createPowerRoll({
                    ...
                    tier1:
                      '11 damage; if the target is size 1 or smaller, who has M < [weak] is grabbed',
                    tier2:
                      '16 damage; if the target is size 1 or smaller, who has M < [average] is grabbed',
                    tier3:
                      '21 damage; if the target is size 1 or smaller, who has M < [strong] is grabbed',
                  }),
                ),
                FactoryLogic.createAbilitySectionText(
