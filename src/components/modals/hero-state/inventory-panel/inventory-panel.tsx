...
export const InventoryPanel = (props: Props) => {
  ...
  if (
    ...
    warning = (
      <Alert type="warning" showIcon={true} title="You can only use 3 leveled items at a time." />
    );
  }
  ...
  return (
    <ErrorBoundary>
      <Space orientation="vertical" style={{ width: '100%', paddingBottom: '20px' }}>
        ...
        {items.length === 0 ? <Empty text="Your inventory is empty." /> : null}
        <Drawer
          open={shopVisible}
