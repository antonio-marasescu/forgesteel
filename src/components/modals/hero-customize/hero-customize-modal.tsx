            ...
            <div className="customize-option-section">
              <Button
                ...
                onClick={() => {
                  setMenuOpen(false);
                  addFeature(
                    FactoryLogic.feature.createAncestryFeature({
                      id: Utils.guid(),
                      value: 1,
                      current: true,
                      former: true,
        ...
        return (
          <div>
            ...
            <Select
              ...
              options={[null, ...SourcebookLogic.getAncestries(props.sourcebooks)].map(o => ({
                value: o ? o.id : '',
                label: o ? o.name : 'Your ancestry',
              }))}
        ...
        return (
          <Space orientation="vertical" style={{ width: '100%' }}>
            ...
            <Select
              ...
              options={[
                FeatureField.AncestryPoints,
                FeatureField.Disengage,
                FeatureField.ProjectPoints,
                FeatureField.Recoveries,
                FeatureField.RecoveryValue,
                FeatureField.Renown,
                FeatureField.Save,
                FeatureField.Speed,
                FeatureField.Stability,
                FeatureField.Stamina,
                FeatureField.Wealth,
              ].map(o => ({ value: o }))}
            ...
            <NumberSpin
              label="Per Level After 1st"
              min={0}
              value={feature.data.valuePerLevel}
              onChange={setValuePerLevel}
            />
            <NumberSpin
              label="Per Echelon"
              min={0}
              value={feature.data.valuePerEchelon}
              onChange={setValuePerEchelon}
            />
            <Select
              style={{ width: '100%' }}
        ...
        return (
          <div>
            ...
            <NumberSpin
              ...
              onChange={setCharacteristicBonus}
            />
          </div>
        );
        ...
        return (
          <div>
            ...
            <Select
              ...
              options={[
                { id: '', name: 'Your Class', description: 'An ability from your own class.' },
                ...SourcebookLogic.getClasses(props.sourcebooks),
              ].map(o => ({ value: o.id, label: o.name, description: o.description }))}
              optionRender={option => <div className="ds-text">{option.data.label}</div>}
      ...
      case FeatureType.DamageModifier:
        return (
          <Space orientation="vertical" style={{ width: '100%' }}>
            ...
            <Segmented
              block={true}
              options={[DamageModifierType.Immunity, DamageModifierType.Weakness].map(o => ({
                label: o,
                value: o,
              }))}
            ...
            <NumberSpin
              label="Value"
              min={0}
              value={feature.data.modifiers[0].value}
              onChange={setDamageModifierBonus}
            />
            <NumberSpin
              label="Per Level After 1st"
              min={0}
              value={feature.data.modifiers[0].valuePerLevel}
              onChange={setDamageModifierValuePerLevel}
            />
            <NumberSpin
              label="Per Echelon"
              min={0}
              value={feature.data.modifiers[0].valuePerEchelon}
              onChange={setDamageModifierValuePerEchelon}
            />
            <Select
              style={{ width: '100%' }}
              placeholder="Characteristics"
      ...
      case FeatureType.Follower:
        return (
          <Expander title="Customize">
            <FollowerEditPanel
              follower={feature.data.follower}
        ...
        return (
          <div>
            ...
            <Select
              ...
              mode="multiple"
              allowClear={true}
              options={[KitArmor.Heavy, KitArmor.Light, KitArmor.Medium, KitArmor.Shield].map(
                option => ({ value: option }),
              )}
              optionRender={option => <div className="ds-text">{option.data.value}</div>}
      ...
      <Modal
        content={
          <div className="hero-customize-modal">
            <HeaderText extra={getMenu()}>Customize</HeaderText>
            <Space orientation="vertical" style={{ width: '100%' }}>
              {hero.features
