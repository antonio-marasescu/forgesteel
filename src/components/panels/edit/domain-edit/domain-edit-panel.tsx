...
export const DomainEditPanel = (props: Props) => {
  ...
  const getResourceGainsEditSection = () => {
    ...
    return (
      <Space orientation="vertical" style={{ width: '100%' }}>
        <HeaderText
          extra={<Button type="text" icon={<PlusOutlined />} onClick={() => addResourceGain()} />}
        >
          Resource Gains
        </HeaderText>
        ...
        {domain.resourceGains.length === 0 ? <Empty /> : null}
      </Space>
    );
  };
  ...
  const getDefaultFeaturesEditSection = () => {
    ...
    return (
      <Space orientation="vertical" style={{ width: '100%' }}>
        <HeaderText
          extra={<Button type="text" icon={<PlusOutlined />} onClick={() => addFeature()} />}
        >
          Default Features
        </HeaderText>
        <Space orientation="vertical" style={{ width: '100%' }}>
          ...
          {domain.defaultFeatures.length === 0 ? <Empty /> : null}
        </Space>
      </Space>
    );
  };
