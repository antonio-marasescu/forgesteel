...
export const MontageEditPanel = (props: Props) => {
    ...
    return (
      <Space orientation="vertical" style={{ width: '100%' }}>
        ...
        <Select
          ...
          ].map(diff => ({ value: diff, label: <div className="ds-text">{diff}</div> }))}
  ...
  const getMontageSectionsSection = () => {
    ...
    const setChallengeCharacteristics = (
      sectionIndex: number,
      challengeIndex: number,
    ...
    return (
      <Space orientation="vertical" style={{ width: '100%' }}>
              ...
              items={[
                {
                  ...
                  children: (
                    <div>
                      ...
                      <MarkdownEditor
                        value={s.name}
                        onChange={value => setSectionName(sectionIndex, value)}
                      />
                      <HeaderText>Description</HeaderText>
                      <MarkdownEditor
                        value={s.description}
                        onChange={value => setSectionDescription(sectionIndex, value)}
                      />
                    </div>
                  ),
                },
                      ...
                      <HeaderText
                        extra={
                          <Button
                            type="text"
                            icon={<PlusOutlined />}
                            onClick={() => addChallenge(sectionIndex)}
                          />
                        }
                      >
                        Challenges
                        ...
                        <Expander
                          ...
                          extra={[
                            <Button
                              ...
                              onClick={e => {
                                e.stopPropagation();
                                moveChallenge(sectionIndex, challengeIndex, 'up');
                              }}
                            />,
                            <Button
                              key="down"
                              ...
                              onClick={e => {
                                e.stopPropagation();
                                moveChallenge(sectionIndex, challengeIndex, 'down');
                              }}
                            />,
                            <DangerButton
                              key="delete"
                              ...
                              onConfirm={e => {
                                e.stopPropagation();
                                deleteChallenge(sectionIndex, c.id);
                              }}
                            />,
                          ]}
                        >
                          ...
                          <TextInput
                            ...
                            value={c.name}
                            onChange={value =>
                              setChallengeName(sectionIndex, challengeIndex, value)
                            }
                          />
                          <HeaderText>Description</HeaderText>
                          <MarkdownEditor
                            value={c.description}
                            onChange={value =>
                              setChallengeDescription(sectionIndex, challengeIndex, value)
                            }
                          />
                          ...
                          <Select
                            ...
                            optionRender={option => (
                              <div className="ds-text">{option.data.value}</div>
                            )}
                            value={c.characteristics}
                            onChange={value =>
                              setChallengeCharacteristics(sectionIndex, challengeIndex, value)
                            }
                          />
                          ...
                          <TextInput
                            ...
                            value={c.skills}
                            onChange={value =>
                              setChallengeSkills(sectionIndex, challengeIndex, value)
                            }
                          />
                          ...
                          <TextInput
                            ...
                            value={c.abilities}
                            onChange={value =>
                              setChallengeAbilities(sectionIndex, challengeIndex, value)
                            }
                          />
                          ...
                          <NumberSpin
                            ...
                            value={c.uses}
                            onChange={value =>
                              setChallengeUses(sectionIndex, challengeIndex, value)
                            }
                          />
                        </Expander>
                      ))}
                      {s.challenges.length === 0 ? <Empty /> : null}
                    </Space>
                  ),
                },
                {
                  ...
                  children: (
                    <Space orientation="vertical" style={{ width: '100%' }}>
                      ...
                      <MarkdownEditor
                        value={s.twistInfo}
                        onChange={value => setSectionTwistInfo(sectionIndex, value)}
                      />
                      {s.twists.map((t, twistIndex) => (
                        <Expander
                          ...
                          extra={[
                            <Button
                              ...
                              onClick={e => {
                                e.stopPropagation();
                                moveTwist(sectionIndex, twistIndex, 'up');
                              }}
                            />,
                            <Button
                              key="down"
                              ...
                              onClick={e => {
                                e.stopPropagation();
                                moveTwist(sectionIndex, twistIndex, 'down');
                              }}
                            />,
                            <DangerButton
                              key="delete"
                        ...
                        >
                          ...
                          <MarkdownEditor
                            value={t.description}
                            onChange={value => setTwistDescription(sectionIndex, twistIndex, value)}
                          />
                          <HeaderText>Characteristics</HeaderText>
                          <Select
                            style={{ width: '100%' }}
                            ...
                            onChange={value =>
                              setTwistCharacteristics(sectionIndex, twistIndex, value)
                            }
                          />
                          <HeaderText>Skills</HeaderText>
                          <TextInput
                          ...
                          <NumberSpin
                            ...
                            min={1}
                            value={t.uses}
                            onChange={value => setTwistUses(sectionIndex, twistIndex, value)}
                          />
                        </Expander>
                      ))}
                      {s.challenges.length === 0 ? <Empty /> : null}
        ...
        {montage.sections.length === 0 ? <Empty /> : null}
      </Space>
    );
  };
