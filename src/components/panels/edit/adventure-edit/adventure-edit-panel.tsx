        ...
        items={[
          ...
          },
          {
            ...
            children: (
              <Space orientation="vertical" style={{ width: '100%' }}>
                <HeaderText
                  extra={<Button type="text" icon={<PlusOutlined />} onClick={addSection} />}
                >
                  Sections
                </HeaderText>
                  ...
                  >
                    ...
                    <Space orientation="vertical" style={{ width: '100%' }}>
                      ...
                      <MarkdownEditor
                        ...
                        onChange={value => setSectionDescription(n, value)}
                      />
                    </Space>
                  </Expander>
                ))}
                {adventure.introduction.length === 0 ? <Empty /> : null}
              </Space>
            ),
          },
          {
            ...
            children: (
              <Space orientation="vertical" style={{ width: '100%' }}>
                ...
                {currentPlot.plots.length === 0 ? <Empty /> : null}
              </Space>
            ),
          },
        ]}
  ...
  return (
    <ErrorBoundary>
      <div className="adventure-edit-panel">
        ...
        <div className="plot-editor">{getEditor()}</div>
      </div>
    </ErrorBoundary>
  );
};
