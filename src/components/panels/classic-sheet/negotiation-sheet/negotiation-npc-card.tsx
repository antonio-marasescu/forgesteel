    ...
    <div className="negotiation-npc card">
      ...
      <section className="bordered">
        ...
        {negotiation.motivations[0] ? (
          <Markdown
            text={
              `**${negotiation.motivations[0].trait}:** ` + negotiation.motivations[0]?.description
            }
          />
        ) : null}
        {negotiation.motivations[1] ? (
          <Markdown
            text={
              `**${negotiation.motivations[1].trait}:** ` + negotiation.motivations[1]?.description
            }
          />
        ) : null}
      </section>
      ...
      <section className="bordered">
        ...
        {negotiation.pitfalls[0] ? (
          <Markdown
            text={`**${negotiation.pitfalls[0].trait}:** ` + negotiation.pitfalls[0]?.description}
          />
        ) : null}
        {negotiation.pitfalls[1] ? (
          <Markdown
            text={`**${negotiation.pitfalls[1].trait}:** ` + negotiation.pitfalls[1]?.description}
          />
        ) : null}
      ...
      <section className="bordered">
        ...
        <p className="languages">Languages: {negotiation.languages.join(', ')}</p>
      </section>
    </div>
  );
};
