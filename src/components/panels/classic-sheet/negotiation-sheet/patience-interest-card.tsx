    ...
    <div className="negotiation-patience-interest card">
      <div className="patience">
        ...
        <div className="current-patience">
          <div className="field">{negotiation.patience}</div>
        ...
        <div className="patience-reference">
          <p className="reference">
            One hero shares NPC's native language (non-Caelian): <strong>Patience +1</strong>
          </p>
          <p className="reference">
            Three or more heroes shares NPC's native language (non-Caelian):{' '}
            <strong>Patience +2</strong>
          </p>
        </div>
      </div>
