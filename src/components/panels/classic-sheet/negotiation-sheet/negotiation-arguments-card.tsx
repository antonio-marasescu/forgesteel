    ...
    <div className="negotiation-arguments card">
      ...
      <div className="reference-rolls">
        <div className="appeal-roll">
          ...
          <div className="power-roll">
            ...
            <div className="roll-tiers">
              <div className="tier t1">
                ...
                <span className="effect">The NPC's patience decreases by 1.</span>
              </div>
          ...
          <p>
            If the heroes attempt to appeal to a motivation that's already been appealed to, the
            NPC's interest remains the same and their patience decreases by 1.
          </p>
        </div>
          ...
          <div className="power-roll">
            ...
            <div className="roll-tiers">
              ...
              <div className="tier t3">
                <img alt="17 +" className="range" src={rollT3Icon} />
                <span className="effect">
                  The NPC's interest increases by 1, and their patience decreases by 1. (on a
                  natural 19 or 20, the NPC's patience remains the same.)
                </span>
              </div>
            </div>
          </div>
          <p>
            If the heroes try to use the same argument without a pitfall or motivation twice, the
            test automatically gets a tier 1 result.
          </p>
        </div>
      </div>
    </div>
