  ...
  return (
    <div className="culture card">
      ...
      <section className="name bordered">
        <h3>Culture Name</h3>
        <div className="content">{character.culture?.name}</div>
      </section>
      <section className="culture-language bordered">
        <h3>Culture Language</h3>
        {character.culture?.language ? (
          <FeatureComponent feature={character.culture?.language} hero={character.hero} />
        ) : null}
      </section>
      <div className="culture-edge">
        <p>
          You gain an edge on tests made to recall lore about your culture, and on tests made to
          influence and interact with people of your culture.
        </p>
      </div>
      <section className="bordered">
        ...
        {character.culture?.environment ? (
          <FeatureComponent feature={character.culture?.environment} hero={character.hero} />
        ) : undefined}
      </section>
      <section className="bordered">
        <h3>Organization</h3>
        ...
        {character.culture?.organization ? (
          <FeatureComponent feature={character.culture?.organization} hero={character.hero} />
        ) : undefined}
      </section>
      <section className="bordered">
        <h3>Upbringing</h3>
        ...
        {character.culture?.upbringing ? (
          <FeatureComponent feature={character.culture?.upbringing} hero={character.hero} />
        ) : undefined}
      </section>
