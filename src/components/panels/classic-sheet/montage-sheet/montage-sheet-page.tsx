...
export const MontageSheetPage = (props: Props) => {
  ...
  const sheetClasses = useMemo(() => {
    const classes = ['montage-sheet', props.options.classicSheetPageSize.toLowerCase()];
    ...
    <main id="classic-sheet">
      <div className={sheetClasses.join(' ')}>
        <div
          ...
          id={SheetFormatter.getPageId('montage', montage.id)}
        >
                ...
                <div className="roll-tiers">
                  <div className="tier t1">
                    ...
                    <span className="effect">
                      You get in the way or make things worse. The creature takes a bane on their
                      test
                    </span>
                  </div>
