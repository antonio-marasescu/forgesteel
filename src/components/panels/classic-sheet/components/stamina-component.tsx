    ...
    <div className="stamina">
      ...
      <div className="current-state">
        <div className="winded">
          ...
          />
          <div className="ref">
            ≤ <span className="data">{stamina.windedAt}</span>
          </div>
        </div>
        <div className="dying">
          <LabeledBooleanField
          ...
          />
          <div className="ref">
            0 to <span className="data">{stamina.deadAt}</span>
          </div>
        </div>
      </div>
      <div className="reference">
        <LabeledTextField
          ...
          additionalClasses={['no-box']}
        />
        <LabeledTextField label="Max" content={stamina.max} additionalClasses={['no-box']} />
      </div>
    </div>
  );
};
