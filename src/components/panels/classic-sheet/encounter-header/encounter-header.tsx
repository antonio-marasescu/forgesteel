  ...
  return (
    <div className="encounter-header card">
      ...
      <section className="container overview">
        ...
        />
        <LabeledTextField label="Number of Heroes" content={encounter.heroCount} />
        <LabeledTextField label="Average Level" content={encounter.heroLvl} />
        <LabeledTextField label="Heroes’ Victories" content={encounter.heroVictories} />
        <LabeledTextField
          label="Difficulty"
          content={encounter.difficulty}
          additionalClasses={['difficulty']}
        />
        <LabeledTextField label="Victories" content={encounter.encounterVictories} />
        <LabeledTextField label="EV" content={encounter.encounterEv} />
      </section>
      ...
      <div className="encounter-tracker">
        <div className="round-tracker">
          <LabeledTextField content="" label="Round" additionalClasses={['label-above', 'fancy']} />
