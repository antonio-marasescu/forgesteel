    ...
    <ErrorBoundary>
      <div className="health-gauge">
        ...
        <Progress
          ...
          type="dashboard"
          percent={
            (100 * (props.stamina!.staminaMax - props.stamina!.staminaDamage)) /
        ...
        {props.recoveries && props.recoveries.recoveriesMax > 0 ? (
          <Progress
            ...
            type="dashboard"
            percent={
              (100 * (props.recoveries!.recoveriesMax - props.recoveries!.recoveriesUsed)) /
              props.recoveries!.recoveriesMax
            }
            showInfo={false}
            status="active"
          />
          ...
          {props.recoveries && props.recoveries.recoveriesMax > 0 ? (
            <>
              ...
              <div>
                Rec{' '}
                <b>
                  {props.recoveries!.recoveriesUsed
                    ? `${props.recoveries!.recoveriesMax - props.recoveries!.recoveriesUsed} / ${props.recoveries!.recoveriesMax}`
                    : `${props.recoveries!.recoveriesMax}`}
                </b>
              </div>
            </>
