...
export const ComplicationPanel = (props: Props) => {
  ...
  if (props.sourcebooks.length > 0) {
    const sourcebookType =
      SourcebookLogic.getComplicationSourcebook(props.sourcebooks, props.complication)?.type ||
  ...
  return (
    <ErrorBoundary>
      <div
        className={
          props.mode === PanelMode.Full ? 'complication-panel' : 'complication-panel compact'
        }
        id={
          props.mode === PanelMode.Full
            ? SheetFormatter.getPageId('complication', props.complication.id)
            : undefined
        }
      >
