      ...
      <div className="standard-abilities-panel">
        <div className="standard-abilities-page" id="mains">
          <div className="standard-abilities-row">
            ...
            <AbilityPanel
              ability={AbilityData.freeStrike}
              hero={props.hero}
              mode={PanelMode.Full}
            />
          ...
          <div className="standard-abilities-row">
            ...
            <AbilityPanel
              ability={AbilityData.opportunityAttack}
              hero={props.hero}
              mode={PanelMode.Full}
            />
          </div>
        ...
        <div className="standard-abilities-page" id="maneuvers">
          <div className="standard-abilities-row">
            ...
            <AbilityPanel
              ability={AbilityData.catchBreath}
              hero={props.hero}
              mode={PanelMode.Full}
            />
            ...
            <AbilityPanel
              ability={AbilityData.escapeGrab}
              hero={props.hero}
              mode={PanelMode.Full}
            />
          </div>
