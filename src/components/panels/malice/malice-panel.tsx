...
export const MalicePanel = (props: Props) => {
  const cost =
    props.malice.type === FeatureType.MaliceAbility
      ? (props.malice.data.ability.cost as number)
      : props.malice.data.cost;
      ...
      <SelectablePanel key={props.malice.id}>
        <div className="malice-panel">
          <FeaturePanel
            ...
            cost={cost}
            repeatable={
              props.malice.type === FeatureType.Malice ? props.malice.data.repeatable : undefined
            }
            mode={PanelMode.Full}
          />
          {props.currentMalice !== undefined ? (
            props.currentMalice >= cost ? (
              ...
              <div className="malice-progress">
                <Progress
                  percent={(100 * props.currentMalice) / cost}
                  steps={cost}
                  showInfo={false}
                />
