    ...
    <div className="hero-edit-content start-section">
      <div className="hero-edit-content-column selected">
        <SelectablePanel>
          ...
          <ul>
            <li>
              Use the tabs above to select your hero's <code>Ancestry</code>, <code>Culture</code>,{' '}
              <code>Career</code>, and <code>Class</code>. If there are any choices to be made,
              you'll be prompted to make your selections.
            </li>
            <li>
              Optionally, you can choose a <code>Complication</code> - but you can skip this if
              you'd prefer.
            </li>
            <li>
          ...
          <div className="ds-text">
            When you're done, click <code>Save Changes</code> in the toolbar at the top, and you'll
            see your hero sheet.
          </div>
        </SelectablePanel>
      </div>
      <div className="hero-edit-content-column choices">
        ...
        <div className="ds-text">This hero can use content from the following sourcebooks:</div>
        {[
          SourcebookType.Official,
          SourcebookType.ThirdParty,
          SourcebookType.Community,
          SourcebookType.Homebrew,
        ].map(type => (
            ...
            {props.sourcebooks
              ...
              .map(sb => (
                <Toggle
                  ...
                  label={
                    <Field
                      label={sb.name || 'Unnamed Sourcebook'}
                      value={<Markdown text={sb.description} useSpan={true} />}
                    />
                  }
        ...
        <Flex align="center" gap={10}>
          <div className="ds-text">
            If you have a homebrew sourcebook you want to use, and it isn't listed here, you can
            import it now.
          </div>
          <Upload
            style={{ width: '100%' }}
