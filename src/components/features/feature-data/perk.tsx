...
export const ConfigPerk = (props: ConfigProps) => {
  ...
  const perks = SourcebookLogic.getPerks(props.sourcebooks as Sourcebook[]).filter(p =>
    props.data.lists.includes(p.list),
  );
