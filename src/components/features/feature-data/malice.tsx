...
export const InfoMalice = (props: InfoProps) => {
  const sections = (props.data.sections ?? []).map((section, n) =>
...
export const EditMalice = (props: EditProps) => {
  ...
  const setMaliceSectionPowerRollCharacteristics = (
    data: FeatureMaliceData,
    index: number,
  ...
  return (
    <Space orientation="vertical" style={{ width: '100%' }}>
      ...
      <Space orientation="vertical" style={{ width: '100%' }}>
        ...
        {data.sections.length === 0 ? <Empty /> : null}
        <Flex gap="8px">
          <Button block={true} onClick={() => addMaliceSectionText(data)}>
            Add Text
          </Button>
          <Button block={true} onClick={() => addMaliceSectionPowerRoll(data)}>
            Add a Power Roll
          </Button>
        </Flex>
      </Space>
