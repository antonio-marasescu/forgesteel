...
type FeatureOf<Type extends FeatureType, Data extends _FeatureData | null = null> = Element & {
  type: Type;
  data: Data;
};
...
export type FeatureAbilityDistance = FeatureOf<
  FeatureType.AbilityDistance,
  FeatureAbilityDistanceData
>;
...
export type FeatureAncestryChoice = FeatureOf<
  FeatureType.AncestryChoice,
  FeatureAncestryChoiceData
>;
...
export type FeatureAncestryFeatureChoice = FeatureOf<
...
export type FeatureCharacteristicBonus = FeatureOf<
  FeatureType.CharacteristicBonus,
  FeatureCharacteristicBonusData
>;
...
export type FeatureConditionImmunity = FeatureOf<
...
export type FeatureDamageModifier = FeatureOf<
...
export type FeatureHeroicResource = FeatureOf<
...
export type FeatureHeroicResourceGain = FeatureOf<
...
export type FeatureLanguageChoice = FeatureOf<
...
export type FeaturePackageContent = FeatureOf<
  FeatureType.PackageContent,
  FeaturePackageContentData
>;
...
export type FeatureTaggedFeatureChoice = FeatureOf<
